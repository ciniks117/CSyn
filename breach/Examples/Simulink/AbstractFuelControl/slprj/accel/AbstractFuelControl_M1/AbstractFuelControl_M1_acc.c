#include "__cf_AbstractFuelControl_M1.h"
#include <math.h>
...
tBuf , real_T * uBuf , real_T * xBuf , int_T bufSz , int_T head , int_T tail
, int_T * pLast , real_T t , real_T tStart , boolean_T discrete , boolean_T
...
fractions [ 0U ] + table [ bpIdx ] ) - yL_1d ) * frac + yL_1d ; } static void
mdlOutputs ( SimStruct * S , int_T tid ) { real32_T rtb_B_1_9_0 ; real32_T
rtb_B_4_0_0 ; boolean_T rtb_B_10_3_0 ; ZCEventType zcEvent ; real_T
rtb_B_13_0_0 ; real32_T rtb_B_13_5_0 ; boolean_T rtb_B_13_4_0 ; real_T
taskTimeV ; uint32_T numCycles ; real_T ratio ; real_T rtb_B_15_37_0 ; real_T
rtb_B_15_30_0 ; B_AbstractFuelControl_M1_T * _rtB ;
P_AbstractFuelControl_M1_T * _rtP ; X_AbstractFuelControl_M1_T * _rtX ;
PrevZCX_AbstractFuelControl_M1_T * _rtZCE ; DW_AbstractFuelControl_M1_T *
_rtDW ; _rtDW = ( ( DW_AbstractFuelControl_M1_T * ) ssGetRootDWork ( S ) ) ;
_rtZCE = ( ( PrevZCX_AbstractFuelControl_M1_T * ) _ssGetPrevZCSigState ( S )
...
= _rtX -> p00543bar_CSTATE ; if ( ssIsMajorTimeStep ( S ) ) { _rtDW ->
EngineSpeed9001100_MODE = ( ( ExternalUPtrs_AbstractFuelControl_M1_T * )
ssGetU ( S ) ) -> EngineSpeed >= _rtP -> P_8 ? 1 : ( (
ExternalUPtrs_AbstractFuelControl_M1_T * ) ssGetU ( S ) ) -> EngineSpeed >
_rtP -> P_9 ? 0 : - 1 ; } _rtB -> B_15_1_0 = _rtDW -> EngineSpeed9001100_MODE
== 1 ? _rtP -> P_8 : _rtDW -> EngineSpeed9001100_MODE == - 1 ? _rtP -> P_9 :
( ( ExternalUPtrs_AbstractFuelControl_M1_T * ) ssGetU ( S ) ) -> EngineSpeed
; _rtB -> B_15_2_0 = _rtP -> P_10 * _rtB -> B_15_1_0 ; _rtB -> B_15_4_0 = ( (
( 0.08979 * _rtB -> B_15_0_0 * _rtB -> B_15_2_0 + - 0.366 ) - 0.0337 * _rtB
-> B_15_2_0 * _rtB -> B_15_0_0 * _rtB -> B_15_0_0 ) + 0.0001 * _rtB ->
B_15_0_0 * _rtB -> B_15_2_0 * _rtB -> B_15_2_0 ) * _rtP -> P_86 ; if (
...
B_15_18_0 * _rtB -> B_15_20_0 ; if ( ssIsSampleHit ( S , 1 , 0 ) ) { { if (
...
, 0 , ssGetTaskTime ( S , 1 ) , ( void * ) & _rtB -> B_15_21_0 ) ; } } _rtDW
-> AFSensorFaultInjection_MODE = ( ssGetTaskTime ( S , 1 ) >= _rtP -> P_27 )
; if ( _rtDW -> AFSensorFaultInjection_MODE == 1 ) { _rtB -> B_15_33_0 = _rtP
-> P_29 ; } else { _rtB -> B_15_33_0 = _rtP -> P_28 ; } } _rtB -> B_15_23_0 =
_rtP -> P_19 * _rtB -> B_15_2_0 ; _rtB -> B_15_24_0 = _rtB -> B_15_4_0 / _rtB
-> B_15_2_0 ; _rtB -> B_15_25_0 = _rtP -> P_20 * _rtB -> B_15_24_0 ; _rtB ->
B_15_26_0 = look2_binlxpw ( _rtB -> B_15_23_0 , _rtB -> B_15_25_0 , _rtP ->
P_22 , _rtP -> P_23 , _rtP -> P_21 , _rtP -> P_87 , 5U ) ; _rtB -> B_15_27_0
= _rtP -> P_24 * _rtB -> B_15_26_0 ; _rtDW -> engine_speed = ( real32_T )
_rtB -> B_15_2_0 ; _rtDW -> throttle_angle = ( real32_T ) _rtB -> B_15_10_0 ;
rtb_B_15_30_0 = _rtP -> P_25 * _rtB -> B_15_21_0 ; _rtB -> B_15_34_0 = _rtX
-> Integrator_CSTATE ; _rtB -> B_15_35_0 = _rtP -> P_31 * _rtB -> B_15_34_0 ;
if ( _rtB -> B_15_33_0 >= _rtP -> P_32 ) { rtb_B_15_37_0 = _rtB -> B_15_32_0
; } else { rtb_B_15_37_0 = _rtB -> B_15_35_0 ; } rtb_B_15_37_0 *= _rtP ->
P_33 ; if ( ssIsSampleHit ( S , 1 , 0 ) ) { _rtDW -> Pwon_MODE = (
ssGetTaskTime ( S , 1 ) >= _rtP -> P_0 ) ; if ( _rtDW -> Pwon_MODE == 1 ) {
rtb_B_13_0_0 = _rtP -> P_2 ; } else { rtb_B_13_0_0 = _rtP -> P_1 ; } } if (
ssIsSampleHit ( S , 3 , 0 ) ) { taskTimeV = ssGetTaskTime ( S , 3 ) ; if (
ssGetTNextWasAdjusted ( S , 3 ) ) { _rtDW -> nextTime = _ssGetVarNextHitTime
( S , 0 ) ; } if ( _rtDW -> justEnabled != 0 ) { _rtDW -> justEnabled = 0 ;
if ( taskTimeV >= _rtP -> P_6 ) { ratio = ( taskTimeV - _rtP -> P_6 ) / _rtP
-> P_4 ; numCycles = ( uint32_T ) muDoubleScalarFloor ( ratio ) ; if (
muDoubleScalarAbs ( ( real_T ) ( numCycles + 1U ) - ratio ) < DBL_EPSILON *
ratio ) { numCycles ++ ; } _rtDW -> numCompleteCycles = numCycles ; ratio = (
( real_T ) numCycles * _rtP -> P_4 + _rtP -> P_6 ) + _rtP -> P_5 * _rtP ->
P_4 / 100.0 ; if ( taskTimeV < ratio ) { _rtDW -> currentValue = 1 ; _rtDW ->
nextTime = ratio ; } else { _rtDW -> currentValue = 0 ; _rtDW -> nextTime = (
real_T ) ( numCycles + 1U ) * _rtP -> P_4 + _rtP -> P_6 ; } } else { _rtDW ->
...
"AbstractFuelControl_M1/Model 1/AF_Controller/DataStoreRead" , NULL ) ; ;
rtb_B_1_9_0 = _rtDW -> commanded_fuel ; ssReadFromDataStoreWithPath ( S , (
int ) _rtDW -> dsmIdx_l ,
"AbstractFuelControl_M1/Model 1/AF_Controller/DataStoreRead1" , NULL ) ; ;
rtb_B_13_4_0 = _rtDW -> controller_mode ; ssReadFromDataStoreWithPath ( S , (
int ) _rtDW -> dsmIdx_e ,
"AbstractFuelControl_M1/Model 1/AF_Controller/DataStoreRead2" , NULL ) ; ;
rtb_B_13_5_0 = _rtDW -> airbyfuel_ref ; _rtB -> B_15_41_0 = _rtP -> P_34 *
rtb_B_1_9_0 ; } _rtB -> B_15_42_0 = _rtB -> B_15_27_0 * _rtB -> B_15_41_0 ;
_rtB -> B_15_43_0 = _rtX -> Integrator_CSTATE_c ; _rtB -> B_15_44_0 =
look2_binlxpw ( _rtB -> B_15_23_0 , _rtB -> B_15_25_0 , _rtP -> P_37 , _rtP
-> P_38 , _rtP -> P_36 , _rtP -> P_88 , 5U ) ; _rtB -> B_15_45_0 = _rtP ->
P_39 * _rtB -> B_15_44_0 ; _rtB -> B_15_46_0 = _rtB -> B_15_43_0 / _rtB ->
B_15_45_0 ; _rtB -> B_15_47_0 = _rtB -> B_15_42_0 + _rtB -> B_15_46_0 ; if (
ssIsSampleHit ( S , 1 , 0 ) ) { { if ( ssGetLogOutput ( S ) ) {
sdiSlioSdiWriteSignal ( _rtDW ->
...
_rtB -> B_15_53_0 = AbstractFuelControl_M1_acc_rt_VTDelayfindtDInterpolate (
...
B_15_58_0 ; if ( ssIsSampleHit ( S , 1 , 0 ) ) { { if ( ssGetLogOutput ( S )
) { sdiSlioSdiWriteSignal ( _rtDW ->
...
ssGetTaskTime ( S , 1 ) , ( void * ) & _rtB -> B_15_26_0 ) ; } } { if (
ssGetLogOutput ( S ) ) { sdiSlioSdiWriteSignal ( _rtDW ->
...
ssGetTaskTime ( S , 1 ) , ( void * ) & _rtB -> B_15_25_0 ) ; } } { if (
ssGetLogOutput ( S ) ) { sdiSlioSdiWriteSignal ( _rtDW ->
...
ssGetTaskTime ( S , 1 ) , ( void * ) & _rtB -> B_15_23_0 ) ; } } { if (
ssGetLogOutput ( S ) ) { sdiSlioSdiWriteSignal ( _rtDW ->
...
ssGetTaskTime ( S , 1 ) , ( void * ) & _rtB -> B_15_44_0 ) ; } } } _rtB ->
B_15_64_0 = _rtP -> P_50 * _rtB -> B_15_27_0 ; _rtB -> B_15_66_0 = _rtB ->
B_15_64_0 + _rtB -> B_15_65_0 ; _rtB -> B_15_67_0 = _rtB -> B_15_41_0 * _rtB
-> B_15_66_0 ; _rtB -> B_15_68_0 = _rtB -> B_15_67_0 - _rtB -> B_15_46_0 ; if
...
16 , 5 , SS_CALL_MDL_OUTPUTS ) ; } UNUSED_PARAMETER ( tid ) ; } static void
mdlOutputsTID4 ( SimStruct * S , int_T tid ) { B_AbstractFuelControl_M1_T *
_rtB ; P_AbstractFuelControl_M1_T * _rtP ; _rtP = ( (
P_AbstractFuelControl_M1_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_AbstractFuelControl_M1_T * ) _ssGetModelBlockIO ( S ) ) ; _rtB -> B_15_8_0
= _rtP -> P_13 ; _rtB -> B_15_12_0 = _rtP -> P_16 ; _rtB -> B_15_16_0 = _rtP
-> P_17 ; _rtB -> B_15_32_0 = _rtP -> P_26 ; _rtB -> B_9_0_0 = _rtP -> P_76 ;
_rtB -> B_8_0_0 = _rtP -> P_74 ; _rtB -> B_8_3_0 = _rtB -> B_8_0_0 + _rtP ->
P_75 ; _rtB -> B_4_5_0 = _rtP -> P_65 ; _rtB -> B_4_7_0 = _rtP -> P_66 ; _rtB
-> B_15_65_0 = _rtP -> P_51 ; UNUSED_PARAMETER ( tid ) ; }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) {
B_AbstractFuelControl_M1_T * _rtB ; P_AbstractFuelControl_M1_T * _rtP ;
DW_AbstractFuelControl_M1_T * _rtDW ; _rtDW = ( ( DW_AbstractFuelControl_M1_T
...
real_T * * xBuffer = ( real_T * * ) & _rtDW -> fuelsystemtransportdelay_PWORK
. TUbufferPtrs [ 2 ] ; real_T simTime = ssGetT ( S ) ; real_T appliedDelay ;
appliedDelay = _rtB -> B_15_57_0 ; if ( appliedDelay > _rtP -> P_42 ) {
...
_rtB ; P_AbstractFuelControl_M1_T * _rtP ; X_AbstractFuelControl_M1_T * _rtX
; XDot_AbstractFuelControl_M1_T * _rtXdot ; DW_AbstractFuelControl_M1_T *
_rtDW ; _rtDW = ( ( DW_AbstractFuelControl_M1_T * ) ssGetRootDWork ( S ) ) ;
...
_rtB ; P_AbstractFuelControl_M1_T * _rtP ; ZCV_AbstractFuelControl_M1_T *
_rtZCSV ; DW_AbstractFuelControl_M1_T * _rtDW ; _rtDW = ( (
...
ssGetU ( S ) ) -> EngineSpeed - _rtP -> P_8 ; _rtZCSV ->
EngineSpeed9001100_LwrLim_ZC = ( ( ExternalUPtrs_AbstractFuelControl_M1_T * )
ssGetU ( S ) ) -> EngineSpeed - _rtP -> P_9 ; _rtZCSV -> theta090_UprLim_ZC =
_rtB -> B_15_9_0 - _rtP -> P_14 ; _rtZCSV -> theta090_LwrLim_ZC = _rtB ->
B_15_9_0 - _rtP -> P_15 ; if ( _rtB -> B_15_13_0 < _rtB -> B_15_14_0 ) { if (
_rtDW -> MinMax_MODE == 0 ) { _rtZCSV -> MinMax_MinmaxInput_ZC = _rtB ->
B_15_13_0 - _rtB -> B_15_13_0 ; } else { _rtZCSV -> MinMax_MinmaxInput_ZC =
_rtB -> B_15_13_0 - _rtB -> B_15_14_0 ; } } else if ( _rtDW -> MinMax_MODE ==
0 ) { _rtZCSV -> MinMax_MinmaxInput_ZC = _rtB -> B_15_14_0 - _rtB ->
B_15_13_0 ; } else { _rtZCSV -> MinMax_MinmaxInput_ZC = _rtB -> B_15_14_0 -
_rtB -> B_15_14_0 ; } _rtZCSV -> Switch_SwitchCond_ZC = _rtB -> B_15_15_0 -
_rtP -> P_18 ; _rtZCSV -> flowdirection_Input_ZC = _rtB -> B_15_19_0 ;
_rtZCSV -> AFSensorFaultInjection_StepTime_ZC = ssGetT ( S ) - _rtP -> P_27 ;
_rtZCSV -> Pwon_StepTime_ZC = ssGetT ( S ) - _rtP -> P_0 ; } static void
mdlInitializeSizes ( SimStruct * S ) { ssSetChecksumVal ( S , 0 , 1379462302U
) ; ssSetChecksumVal ( S , 1 , 3487531952U ) ; ssSetChecksumVal ( S , 2 ,
3971608294U ) ; ssSetChecksumVal ( S , 3 , 1617117619U ) ; { mxArray *
...
) ) ; ( ( P_AbstractFuelControl_M1_T * ) ssGetModelRtp ( S ) ) -> P_52 =
