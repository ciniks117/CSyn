#include "__cf_AbstractFuelControl_M1_breach.h"
#include <math.h>
#include "AbstractFuelControl_M1_breach_acc.h"
#include "AbstractFuelControl_M1_breach_acc_private.h"
#include <stdio.h>
...
#endif
boolean_T AbstractFuelControl_M1_breach_acc_rt_TDelayUpdateTailOrGrowBuf (
...
AbstractFuelControl_M1_breach_acc_rt_VTDelayfindtDInterpolate ( real_T x ,
...
static void mdlOutputs ( SimStruct * S , int_T tid ) { real_T B_15_26_0 ;
real_T B_15_44_0 ; real32_T rtb_B_1_9_0 ; real32_T rtb_B_4_0_0 ; boolean_T
rtb_B_10_3_0 ; ZCEventType zcEvent ; real_T rtb_B_13_0_0 ; real32_T
rtb_B_13_5_0 ; boolean_T rtb_B_13_4_0 ; real_T taskTimeV ; uint32_T numCycles
; real_T ratio ; real_T rtb_B_15_37_0 ; real_T rtb_B_15_30_0 ;
B_AbstractFuelControl_M1_breach_T * _rtB ; P_AbstractFuelControl_M1_breach_T
* _rtP ; X_AbstractFuelControl_M1_breach_T * _rtX ;
PrevZCX_AbstractFuelControl_M1_breach_T * _rtZCE ;
DW_AbstractFuelControl_M1_breach_T * _rtDW ; _rtDW = ( (
DW_AbstractFuelControl_M1_breach_T * ) ssGetRootDWork ( S ) ) ; _rtZCE = ( (
PrevZCX_AbstractFuelControl_M1_breach_T * ) _ssGetPrevZCSigState ( S ) ) ;
_rtX = ( ( X_AbstractFuelControl_M1_breach_T * ) ssGetContStates ( S ) ) ;
_rtP = ( ( P_AbstractFuelControl_M1_breach_T * ) ssGetModelRtp ( S ) ) ; _rtB
= ( ( B_AbstractFuelControl_M1_breach_T * ) _ssGetModelBlockIO ( S ) ) ; _rtB
-> B_15_0_0 = _rtX -> p00543bar_CSTATE ; if ( ssIsMajorTimeStep ( S ) ) {
_rtDW -> EngineSpeed9001100_MODE = ( (
ExternalUPtrs_AbstractFuelControl_M1_breach_T * ) ssGetU ( S ) ) ->
Engine_Speed >= _rtP -> P_8 ? 1 : ( (
ExternalUPtrs_AbstractFuelControl_M1_breach_T * ) ssGetU ( S ) ) ->
Engine_Speed > _rtP -> P_9 ? 0 : - 1 ; } _rtB -> B_15_1_0 = _rtDW ->
EngineSpeed9001100_MODE == 1 ? _rtP -> P_8 : _rtDW -> EngineSpeed9001100_MODE
== - 1 ? _rtP -> P_9 : ( ( ExternalUPtrs_AbstractFuelControl_M1_breach_T * )
ssGetU ( S ) ) -> Engine_Speed ; _rtB -> B_15_2_0 = _rtP -> P_10 * _rtB ->
B_15_1_0 ; _rtB -> B_15_4_0 = ( ( ( 0.08979 * _rtB -> B_15_0_0 * _rtB ->
B_15_2_0 + - 0.366 ) - 0.0337 * _rtB -> B_15_2_0 * _rtB -> B_15_0_0 * _rtB ->
B_15_0_0 ) + 0.0001 * _rtB -> B_15_0_0 * _rtB -> B_15_2_0 * _rtB -> B_15_2_0
) * _rtP -> P_86 ; { if ( ssGetLogOutput ( S ) ) { sdiSlioSdiWriteSignal (
_rtDW -> HiddenToAsyncQueue_InsertedFor_IntakeManifold_at_outport_0_PWORK .
AQHandles , _rtDW ->
HiddenToAsyncQueue_InsertedFor_IntakeManifold_at_outport_0_PWORK . SlioLTF ,
0 , ssGetTaskTime ( S , 0 ) , ( void * ) & _rtB -> B_15_4_0 ) ; } } { if (
...
; if ( ssIsMajorTimeStep ( S ) ) { _rtDW -> theta090_MODE = _rtB -> B_15_9_0
>= _rtP -> P_14 ? 1 : _rtB -> B_15_9_0 > _rtP -> P_15 ? 0 : - 1 ; } _rtB ->
B_15_10_0 = _rtDW -> theta090_MODE == 1 ? _rtP -> P_14 : _rtDW ->
theta090_MODE == - 1 ? _rtP -> P_15 : _rtB -> B_15_9_0 ; _rtB -> B_15_13_0 =
_rtB -> B_15_0_0 / _rtB -> B_15_12_0 ; _rtB -> B_15_14_0 = 1.0 / _rtB ->
B_15_0_0 * _rtB -> B_15_12_0 ; if ( ssIsMajorTimeStep ( S ) ) { rtb_B_15_30_0
= _rtB -> B_15_13_0 ; _rtDW -> MinMax_MODE = 0 ; if ( _rtB -> B_15_14_0 <
_rtB -> B_15_13_0 ) { rtb_B_15_30_0 = _rtB -> B_15_14_0 ; _rtDW ->
MinMax_MODE = 1 ; } _rtB -> B_15_15_0 = rtb_B_15_30_0 ; _rtDW -> Switch_Mode
= ( _rtB -> B_15_15_0 >= _rtP -> P_18 ) ; } else { rtb_B_15_30_0 = _rtB ->
B_15_13_0 ; if ( _rtDW -> MinMax_MODE == 1 ) { rtb_B_15_30_0 = _rtB ->
B_15_14_0 ; } _rtB -> B_15_15_0 = rtb_B_15_30_0 ; } if ( _rtDW -> Switch_Mode
...
) ; } _rtB -> B_14_0_0 = 2.0 * rtb_B_15_30_0 ; _rtB -> B_15_18_0 = _rtB ->
B_14_0_0 ; } else { _rtB -> B_15_18_0 = _rtB -> B_15_16_0 ; } _rtB ->
B_15_19_0 = _rtB -> B_15_12_0 - _rtB -> B_15_0_0 ; if ( ssIsSampleHit ( S , 1
, 0 ) ) { if ( _rtB -> B_15_19_0 > 0.0 ) { _rtDW -> flowdirection_MODE = 1 ;
} else if ( _rtB -> B_15_19_0 < 0.0 ) { _rtDW -> flowdirection_MODE = - 1 ; }
else { _rtDW -> flowdirection_MODE = 0 ; } _rtB -> B_15_20_0 = _rtDW ->
...
B_15_18_0 * _rtB -> B_15_20_0 ; { if ( ssGetLogOutput ( S ) ) {
...
B_15_24_0 ; B_15_26_0 = look2_binlxpw ( _rtB -> B_15_23_0 , _rtB -> B_15_25_0
, _rtP -> P_22 , _rtP -> P_23 , _rtP -> P_21 , _rtP -> P_87 , 5U ) ; _rtB ->
B_15_27_0 = _rtP -> P_24 * B_15_26_0 ; _rtDW -> engine_speed = ( real32_T )
_rtB -> B_15_2_0 ; _rtDW -> throttle_angle = ( real32_T ) _rtB -> B_15_10_0 ;
rtb_B_15_30_0 = _rtP -> P_25 * _rtB -> B_15_21_0 ; if ( ssIsSampleHit ( S , 1
, 0 ) ) { _rtDW -> AFSensorFaultInjection_MODE = ( ssGetTaskTime ( S , 1 ) >=
_rtP -> P_27 ) ; if ( _rtDW -> AFSensorFaultInjection_MODE == 1 ) { _rtB ->
B_15_33_0 = _rtP -> P_29 ; } else { _rtB -> B_15_33_0 = _rtP -> P_28 ; } }
_rtB -> B_15_34_0 = _rtX -> Integrator_CSTATE ; _rtB -> B_15_35_0 = _rtP ->
P_31 * _rtB -> B_15_34_0 ; if ( _rtB -> B_15_33_0 >= _rtP -> P_32 ) {
rtb_B_15_37_0 = _rtB -> B_15_32_0 ; } else { rtb_B_15_37_0 = _rtB ->
B_15_35_0 ; } rtb_B_15_37_0 *= _rtP -> P_33 ; if ( ssIsSampleHit ( S , 1 , 0
) ) { _rtDW -> Pwon_MODE = ( ssGetTaskTime ( S , 1 ) >= _rtP -> P_0 ) ; if (
_rtDW -> Pwon_MODE == 1 ) { rtb_B_13_0_0 = _rtP -> P_2 ; } else {
...
dsmIdx_f ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/DataStoreWrite"
, NULL ) ; ; ssWriteToDataStoreWithPath ( S , ( int ) _rtDW -> dsmIdx_m ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/DataStoreWrite3"
, NULL ) ; ; _rtDW -> throttle_flow = ( real32_T ) rtb_B_15_30_0 ;
ssWriteToDataStoreWithPath ( S , ( int ) _rtDW -> dsmIdx_h ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/DataStoreWrite1"
, NULL ) ; ; _rtDW -> airbyfuel_meas = ( real32_T ) rtb_B_15_37_0 ;
ssWriteToDataStoreWithPath ( S , ( int ) _rtDW -> dsmIdx_ha ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/DataStoreWrite2"
...
ssWriteToDataStoreWithPath ( S , ( int ) _rtDW -> dsmIdx_l ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/fuel_controller_pwon/DataStoreWrite1"
, NULL ) ; ; _rtDW -> commanded_fuel = _rtP -> P_78 ;
ssWriteToDataStoreWithPath ( S , ( int ) _rtDW -> dsmIdx ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/fuel_controller_pwon/DataStoreWrite"
, NULL ) ; ; _rtDW -> airbyfuel_ref = _rtP -> P_79 ;
ssWriteToDataStoreWithPath ( S , ( int ) _rtDW -> dsmIdx_e ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/fuel_controller_pwon/DataStoreWrite2"
...
NO_ZCEVENT ) { ssReadFromDataStoreWithPath ( S , ( int ) _rtDW -> dsmIdx_ha ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/fuel_controller_mode_10ms/DataStoreRead2"
...
_rtDW -> dsmIdx_m ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/fuel_controller_mode_10ms/DataStoreRead4"
...
_rtDW -> dsmIdx_l ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/fuel_controller_mode_10ms/DataStoreWrite"
, NULL ) ; ; if ( _rtB -> B_7_6_0 && _rtB -> B_8_5_0 ) { _rtDW ->
airbyfuel_ref = _rtP -> P_70 ; } else { _rtDW -> airbyfuel_ref = _rtP -> P_69
; } ssWriteToDataStoreWithPath ( S , ( int ) _rtDW -> dsmIdx_e ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/fuel_controller_mode_10ms/DataStoreWrite1"
...
ssReadFromDataStoreWithPath ( S , ( int ) _rtDW -> dsmIdx_h ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/fuel_controller_10ms/DataStoreRead"
, NULL ) ; ; rtb_B_4_0_0 = _rtDW -> throttle_flow ;
ssReadFromDataStoreWithPath ( S , ( int ) _rtDW -> dsmIdx_f ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/fuel_controller_10ms/DataStoreRead1"
...
, ( int ) _rtDW -> dsmIdx_e ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/fuel_controller_10ms/DataStoreRead4"
, NULL ) ; ; rtb_B_4_0_0 = _rtDW -> airbyfuel_ref ; rtb_B_1_9_0 /= _rtDW ->
airbyfuel_ref ; ssReadFromDataStoreWithPath ( S , ( int ) _rtDW -> dsmIdx_l ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/fuel_controller_10ms/DataStoreRead3"
, NULL ) ; ; rtb_B_10_3_0 = _rtDW -> controller_mode ;
ssReadFromDataStoreWithPath ( S , ( int ) _rtDW -> dsmIdx_ha ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/fuel_controller_10ms/DataStoreRead2"
...
rtb_B_4_0_0 ; } ssWriteToDataStoreWithPath ( S , ( int ) _rtDW -> dsmIdx ,
 "AbstractFuelControl_M1_breach/Model 1/AF_Controller/fuel_controller/fuel_controller_10ms/DataStoreWrite"
...
"AbstractFuelControl_M1_breach/Model 1/AF_Controller/DataStoreRead" , NULL )
; ; rtb_B_1_9_0 = _rtDW -> commanded_fuel ; ssReadFromDataStoreWithPath ( S ,
( int ) _rtDW -> dsmIdx_l ,
"AbstractFuelControl_M1_breach/Model 1/AF_Controller/DataStoreRead1" , NULL )
; ; rtb_B_13_4_0 = _rtDW -> controller_mode ; ssReadFromDataStoreWithPath ( S
, ( int ) _rtDW -> dsmIdx_e ,
"AbstractFuelControl_M1_breach/Model 1/AF_Controller/DataStoreRead2" , NULL )
; ; rtb_B_13_5_0 = _rtDW -> airbyfuel_ref ; _rtB -> B_15_41_0 = _rtP -> P_34
* rtb_B_1_9_0 ; } _rtB -> B_15_42_0 = _rtB -> B_15_27_0 * _rtB -> B_15_41_0 ;
_rtB -> B_15_43_0 = _rtX -> Integrator_CSTATE_c ; B_15_44_0 = look2_binlxpw (
_rtB -> B_15_23_0 , _rtB -> B_15_25_0 , _rtP -> P_37 , _rtP -> P_38 , _rtP ->
P_36 , _rtP -> P_88 , 5U ) ; _rtB -> B_15_45_0 = _rtP -> P_39 * B_15_44_0 ;
_rtB -> B_15_46_0 = _rtB -> B_15_43_0 / _rtB -> B_15_45_0 ; _rtB -> B_15_47_0
= _rtB -> B_15_42_0 + _rtB -> B_15_46_0 ; { if ( ssGetLogOutput ( S ) ) {
sdiSlioSdiWriteSignal ( _rtDW ->
...
AbstractFuelControl_M1_breach_acc_rt_VTDelayfindtDInterpolate ( ( (
X_AbstractFuelControl_M1_breach_T * ) ssGetContStates ( S ) ) ->
...
B_15_58_0 ; { if ( ssGetLogOutput ( S ) ) { sdiSlioSdiWriteSignal ( _rtDW ->
HiddenToAsyncQueue_InsertedFor_1Kappa_at_outport_0_PWORK . AQHandles , _rtDW
-> HiddenToAsyncQueue_InsertedFor_1Kappa_at_outport_0_PWORK . SlioLTF , 0 ,
ssGetTaskTime ( S , 0 ) , ( void * ) & B_15_26_0 ) ; } } { if (
ssGetLogOutput ( S ) ) { sdiSlioSdiWriteSignal ( _rtDW ->
HiddenToAsyncQueue_InsertedFor_From2_at_outport_0_PWORK . AQHandles , _rtDW
-> HiddenToAsyncQueue_InsertedFor_From2_at_outport_0_PWORK . SlioLTF , 0 ,
ssGetTaskTime ( S , 0 ) , ( void * ) & _rtB -> B_15_25_0 ) ; } } { if (
ssGetLogOutput ( S ) ) { sdiSlioSdiWriteSignal ( _rtDW ->
HiddenToAsyncQueue_InsertedFor_From3_at_outport_0_PWORK . AQHandles , _rtDW
-> HiddenToAsyncQueue_InsertedFor_From3_at_outport_0_PWORK . SlioLTF , 0 ,
ssGetTaskTime ( S , 0 ) , ( void * ) & _rtB -> B_15_23_0 ) ; } } { if (
ssGetLogOutput ( S ) ) { sdiSlioSdiWriteSignal ( _rtDW ->
...
ssGetTaskTime ( S , 0 ) , ( void * ) & B_15_44_0 ) ; } } _rtB -> B_15_64_0 =
_rtP -> P_50 * _rtB -> B_15_27_0 ; _rtB -> B_15_66_0 = _rtB -> B_15_64_0 +
_rtB -> B_15_65_0 ; _rtB -> B_15_67_0 = _rtB -> B_15_41_0 * _rtB -> B_15_66_0
; _rtB -> B_15_68_0 = _rtB -> B_15_67_0 - _rtB -> B_15_46_0 ; if (
ssIsSampleHit ( S , 2 , 0 ) ) { _rtB -> B_16_1_0 = rtb_B_13_5_0 ;
ssCallAccelRunBlock ( S , 16 , 2 , SS_CALL_MDL_OUTPUTS ) ; }
ssCallAccelRunBlock ( S , 16 , 3 , SS_CALL_MDL_OUTPUTS ) ; if ( ssIsSampleHit
( S , 2 , 0 ) ) { _rtB -> B_16_4_0 = rtb_B_13_4_0 ; ssCallAccelRunBlock ( S ,
16 , 5 , SS_CALL_MDL_OUTPUTS ) ; } { if ( ssGetLogOutput ( S ) ) {
sdiSlioSdiWriteSignal ( _rtDW ->
...
ExternalUPtrs_AbstractFuelControl_M1_breach_T * ) ssGetU ( S ) ) ->
Engine_Speed ) ; } } { if ( ssGetLogOutput ( S ) ) { sdiSlioSdiWriteSignal (
_rtDW -> HiddenToAsyncQueue_InsertedFor_PedalAngle_at_outport_0_PWORK .
AQHandles , _rtDW ->
HiddenToAsyncQueue_InsertedFor_PedalAngle_at_outport_0_PWORK . SlioLTF , 0 ,
ssGetTaskTime ( S , 0 ) , ( void * ) & ( (
ExternalUPtrs_AbstractFuelControl_M1_breach_T * ) ssGetU ( S ) ) ->
Pedal_Angle ) ; } } UNUSED_PARAMETER ( tid ) ; } static void mdlOutputsTID4 (
SimStruct * S , int_T tid ) { B_AbstractFuelControl_M1_breach_T * _rtB ;
P_AbstractFuelControl_M1_breach_T * _rtP ; _rtP = ( (
P_AbstractFuelControl_M1_breach_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_AbstractFuelControl_M1_breach_T * ) _ssGetModelBlockIO ( S ) ) ; _rtB ->
...
_rtP -> P_66 ; _rtB -> B_15_65_0 = _rtP -> P_51 ; UNUSED_PARAMETER ( tid ) ;
}
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) {
B_AbstractFuelControl_M1_breach_T * _rtB ; P_AbstractFuelControl_M1_breach_T
* _rtP ; DW_AbstractFuelControl_M1_breach_T * _rtDW ; _rtDW = ( (
DW_AbstractFuelControl_M1_breach_T * ) ssGetRootDWork ( S ) ) ; _rtP = ( (
P_AbstractFuelControl_M1_breach_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_AbstractFuelControl_M1_breach_T * ) _ssGetModelBlockIO ( S ) ) ; { real_T *
...
AbstractFuelControl_M1_breach_acc_rt_TDelayUpdateTailOrGrowBuf ( & _rtDW ->
fuelsystemtransportdelay_IWORK . CircularBufSize , & _rtDW ->
fuelsystemtransportdelay_IWORK . Tail , & _rtDW ->
fuelsystemtransportdelay_IWORK . Head , & _rtDW ->
...
B_AbstractFuelControl_M1_breach_T * _rtB ; P_AbstractFuelControl_M1_breach_T
* _rtP ; X_AbstractFuelControl_M1_breach_T * _rtX ;
XDot_AbstractFuelControl_M1_breach_T * _rtXdot ;
DW_AbstractFuelControl_M1_breach_T * _rtDW ; _rtDW = ( (
DW_AbstractFuelControl_M1_breach_T * ) ssGetRootDWork ( S ) ) ; _rtXdot = ( (
XDot_AbstractFuelControl_M1_breach_T * ) ssGetdX ( S ) ) ; _rtX = ( (
X_AbstractFuelControl_M1_breach_T * ) ssGetContStates ( S ) ) ; _rtP = ( (
P_AbstractFuelControl_M1_breach_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_AbstractFuelControl_M1_breach_T * ) _ssGetModelBlockIO ( S ) ) ; _rtXdot ->
...
ExternalUPtrs_AbstractFuelControl_M1_breach_T * ) ssGetU ( S ) ) ->
Pedal_Angle ; _rtXdot -> Integrator_CSTATE = _rtB -> B_15_51_0 ; _rtXdot ->
Integrator_CSTATE_c = _rtB -> B_15_68_0 ; _rtXdot -> Integrator_CSTATE_h =
_rtB -> B_15_55_0 ; { real_T instantDelay ; instantDelay = _rtB -> B_15_57_0
; if ( instantDelay > _rtP -> P_42 ) { instantDelay = _rtP -> P_42 ; } if (
instantDelay < 0.0 ) { ( ( XDot_AbstractFuelControl_M1_breach_T * ) ssGetdX (
S ) ) -> fuelsystemtransportdelay_CSTATE = 0 ; } else { ( (
XDot_AbstractFuelControl_M1_breach_T * ) ssGetdX ( S ) ) ->
fuelsystemtransportdelay_CSTATE = 1.0 / instantDelay ; } } }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) {
B_AbstractFuelControl_M1_breach_T * _rtB ; P_AbstractFuelControl_M1_breach_T
* _rtP ; ZCV_AbstractFuelControl_M1_breach_T * _rtZCSV ;
DW_AbstractFuelControl_M1_breach_T * _rtDW ; _rtDW = ( (
DW_AbstractFuelControl_M1_breach_T * ) ssGetRootDWork ( S ) ) ; _rtZCSV = ( (
ZCV_AbstractFuelControl_M1_breach_T * ) ssGetSolverZcSignalVector ( S ) ) ;
_rtP = ( ( P_AbstractFuelControl_M1_breach_T * ) ssGetModelRtp ( S ) ) ; _rtB
= ( ( B_AbstractFuelControl_M1_breach_T * ) _ssGetModelBlockIO ( S ) ) ;
_rtZCSV -> EngineSpeed9001100_UprLim_ZC = ( (
ExternalUPtrs_AbstractFuelControl_M1_breach_T * ) ssGetU ( S ) ) ->
Engine_Speed - _rtP -> P_8 ; _rtZCSV -> EngineSpeed9001100_LwrLim_ZC = ( (
ExternalUPtrs_AbstractFuelControl_M1_breach_T * ) ssGetU ( S ) ) ->
Engine_Speed - _rtP -> P_9 ; _rtZCSV -> theta090_UprLim_ZC = _rtB -> B_15_9_0
- _rtP -> P_14 ; _rtZCSV -> theta090_LwrLim_ZC = _rtB -> B_15_9_0 - _rtP ->
P_15 ; if ( _rtB -> B_15_13_0 < _rtB -> B_15_14_0 ) { if ( _rtDW ->
MinMax_MODE == 0 ) { _rtZCSV -> MinMax_MinmaxInput_ZC = _rtB -> B_15_13_0 -
_rtB -> B_15_13_0 ; } else { _rtZCSV -> MinMax_MinmaxInput_ZC = _rtB ->
B_15_13_0 - _rtB -> B_15_14_0 ; } } else if ( _rtDW -> MinMax_MODE == 0 ) {
_rtZCSV -> MinMax_MinmaxInput_ZC = _rtB -> B_15_14_0 - _rtB -> B_15_13_0 ; }
else { _rtZCSV -> MinMax_MinmaxInput_ZC = _rtB -> B_15_14_0 - _rtB ->
B_15_14_0 ; } _rtZCSV -> Switch_SwitchCond_ZC = _rtB -> B_15_15_0 - _rtP ->
P_18 ; _rtZCSV -> flowdirection_Input_ZC = _rtB -> B_15_19_0 ; _rtZCSV ->
AFSensorFaultInjection_StepTime_ZC = ssGetT ( S ) - _rtP -> P_27 ; _rtZCSV ->
Pwon_StepTime_ZC = ssGetT ( S ) - _rtP -> P_0 ; } static void
mdlInitializeSizes ( SimStruct * S ) { ssSetChecksumVal ( S , 0 , 3087330168U
) ; ssSetChecksumVal ( S , 1 , 3523160776U ) ; ssSetChecksumVal ( S , 2 ,
734721712U ) ; ssSetChecksumVal ( S , 3 , 963443600U ) ; { mxArray *
...
S ) != sizeof ( DW_AbstractFuelControl_M1_breach_T ) ) { ssSetErrorStatus ( S
, "Unexpected error: Internal DWork sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofGlobalBlockIO ( S
) != sizeof ( B_AbstractFuelControl_M1_breach_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal BlockIO sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofU ( S ) != sizeof
( ExternalUPtrs_AbstractFuelControl_M1_breach_T ) ) { static char msg [ 256 ]
...
( ssGetSizeofY ( S ) != sizeof ( ExtY_AbstractFuelControl_M1_breach_T ) ) {
static char msg [ 256 ] ; sprintf ( msg ,
"Unexpected error: Internal ExternalOutputs sizes do "
"not match for accelerator mex file." ) ; } { int ssSizeofParams ;
ssGetSizeofParams ( S , & ssSizeofParams ) ; if ( ssSizeofParams != sizeof (
P_AbstractFuelControl_M1_breach_T ) ) { static char msg [ 256 ] ; sprintf (
msg , "Unexpected error: Internal Parameters sizes do "
"not match for accelerator mex file." ) ; } } _ssSetModelRtp ( S , ( real_T *
) & AbstractFuelControl_M1_breach_rtDefaultP ) ; rt_InitInfAndNaN ( sizeof (
real_T ) ) ; ( ( P_AbstractFuelControl_M1_breach_T * ) ssGetModelRtp ( S ) )
