...
MODEL              = AbstractFuelControl_M1_breach
MODULES            = AbstractFuelControl_M1_breach_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c
MAKEFILE           = AbstractFuelControl_M1_breach.mk
MATLAB_ROOT        = /usr/local/MATLAB/R2017a
ALT_MATLAB_ROOT    = /usr/local/MATLAB/R2017a
MASTER_ANCHOR_DIR  = 
START_DIR          = /home/nikhil/breach-master/Examples/Simulink/AbstractFuelControl
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 4
...
MODELLIB                  = AbstractFuelControl_M1_breachlib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/accel/AbstractFuelControl_M1_breach \
	-I/home/nikhil/breach-master/Ext/ModelsData \
...
ACCELEXTRALIBS += -L$(MATLAB_ROOT)/bin/$(ARCH) -lmwsl_iofile
...
$(PROGRAM) : $(OBJS) $(SHARED_LIB) $(LIBS)
	@echo "### Linking ..."
	$(CC) $(MEX_FLAGS) $(ARCH_LDFLAGS) -MATLAB_ARCH=$(ARCH) -silent -outdir $(RELATIVE_PATH_TO_ANCHOR) $(LINK_OBJS) $(SHARED_LIB) $(LIBS) $(MATHLIBS) $(ACCELEXTRALIBS)
