...
#include "ne_ds.h"
#include "closedLoop_tuned_57a28c5_2_ds_zc.h"
#include "closedLoop_tuned_57a28c5_2_ds_tdxy_p.h"
#include "closedLoop_tuned_57a28c5_2_ds_y.h"
#include "closedLoop_tuned_57a28c5_2_ds_obs_all.h"
#include "closedLoop_tuned_57a28c5_2_ds_obs_act.h"
#include "closedLoop_tuned_57a28c5_2_ds_m_p.h"
#include "closedLoop_tuned_57a28c5_2_ds_log.h"
#include "closedLoop_tuned_57a28c5_2_ds_dxy_p.h"
#include "closedLoop_tuned_57a28c5_2_ds_dnf_p.h"
#include "closedLoop_tuned_57a28c5_2_ds_tdxf_p.h"
#include "closedLoop_tuned_57a28c5_2_ds_a_p.h"
#include "closedLoop_tuned_57a28c5_2_ds_obs_il.h"
#include "closedLoop_tuned_57a28c5_2_ds_a.h"
#include "closedLoop_tuned_57a28c5_2_ds_dxf_p.h"
#include "closedLoop_tuned_57a28c5_2_ds_dxf.h"
#include "closedLoop_tuned_57a28c5_2_ds_mode.h"
#include "closedLoop_tuned_57a28c5_2_ds_f.h"
#include "closedLoop_tuned_57a28c5_2_ds.h"
...
"closedLoop_tuned/Plant/Robot/Gripper/Mechanical Rotational Reference1" , 1U
, 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE
, TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity"
, } , { "Plant.Robot.Gripper.Mechanical_Rotational_Reference2.W.w" ,
"closedLoop_tuned/Plant/Robot/Gripper/Mechanical Rotational Reference2" , 1U
, 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE
, TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity"
, } , { "Plant.Robot.Gripper.RFA_R.w" ,
"closedLoop_tuned/Plant/Robot/Gripper" , 1U , 1U , "rad/s" , 1.0e-6 , "1/s" ,
NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"Plant.Robot.Gripper.Torque_Actuated_Revolute_Joint_with_Position1.C.w" ,
 "closedLoop_tuned/Plant/Robot/Gripper/Torque Actuated Revolute Joint with Position1"
...
,
 "closedLoop_tuned/Plant/Robot/Gripper/Torque Actuated Revolute Joint with Position1/Rot2Rev"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop_tuned/Plant/Robot/Gripper/Torque Actuated Revolute Joint with Position1/Rot2Rev/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"Plant.Robot.Gripper.Torque_Actuated_Revolute_Joint_with_Position3.C.w" ,
 "closedLoop_tuned/Plant/Robot/Gripper/Torque Actuated Revolute Joint with Position3"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop_tuned/Plant/Robot/Gripper/Torque Actuated Revolute Joint with Position3/Rot2Rev"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop_tuned/Plant/Robot/Gripper/Torque Actuated Revolute Joint with Position3/Rot2Rev/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop_tuned/Plant/Robot" , 1U , 1U , "rad/s" , 1.0e-6 , "1/s" ,
NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"Plant.Robot.Mechanical_Rotational_Reference.W.w" ,
"closedLoop_tuned/Plant/Robot/Mechanical Rotational Reference" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"Plant.Robot.Mechanical_Rotational_Reference1.W.w" ,
"closedLoop_tuned/Plant/Robot/Mechanical Rotational Reference1" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"Plant.Robot.Mechanical_Rotational_Reference2.W.w" ,
"closedLoop_tuned/Plant/Robot/Mechanical Rotational Reference2" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"Plant.Robot.RFA_R.w" , "closedLoop_tuned/Plant/Robot" , 1U , 1U , "rad/s" ,
1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"Plant.Robot.Torque_Actuated_Revolute_Joint_with_Position.C.w" ,
"closedLoop_tuned/Plant/Robot/Torque Actuated Revolute Joint with Position" ,
1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
"Plant.Robot.Torque_Actuated_Revolute_Joint_with_Position.Rot2Rev.C.w" ,
 "closedLoop_tuned/Plant/Robot/Torque Actuated Revolute Joint with Position/Rot2Rev"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop_tuned/Plant/Robot/Torque Actuated Revolute Joint with Position/Rot2Rev/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop_tuned/Plant/Robot/Torque Actuated Revolute Joint with Position1"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
"Plant.Robot.Torque_Actuated_Revolute_Joint_with_Position1.Rot2Rev.C.w" ,
 "closedLoop_tuned/Plant/Robot/Torque Actuated Revolute Joint with Position1/Rot2Rev"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop_tuned/Plant/Robot/Torque Actuated Revolute Joint with Position1/Rot2Rev/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop_tuned/Plant/Robot/Torque Actuated Revolute Joint with Position2"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
"Plant.Robot.Torque_Actuated_Revolute_Joint_with_Position2.Rot2Rev.C.w" ,
 "closedLoop_tuned/Plant/Robot/Torque Actuated Revolute Joint with Position2/Rot2Rev"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop_tuned/Plant/Robot/Torque Actuated Revolute Joint with Position2/Rot2Rev/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop_tuned/Plant/Robot/Torque Actuated Revolute Joint with Position3"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
"Plant.Robot.Torque_Actuated_Revolute_Joint_with_Position3.Rot2Rev.C.w" ,
 "closedLoop_tuned/Plant/Robot/Torque Actuated Revolute Joint with Position3/Rot2Rev"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop_tuned/Plant/Robot/Torque Actuated Revolute Joint with Position3/Rot2Rev/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"Plant.Robot.WA_R.w" , "closedLoop_tuned/Plant/Robot" , 1U , 1U , "rad/s" ,
1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"Plant.Servomotors.C.w" , "closedLoop_tuned/Plant/Servomotors" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{ "Plant.Servomotors.FA_R.w" , "closedLoop_tuned/Plant/Servomotors" , 1U , 1U
, "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity"
, } , { "Plant.Servomotors.Fore_Arm_Servomotor.C.w" ,
"closedLoop_tuned/Plant/Servomotors/Fore Arm Servomotor" , 1U , 1U , "rad/s"
, 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE
, NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
...
"closedLoop_tuned/Plant/Servomotors/Fore Arm Servomotor/Uncontrolled Servomotor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
"Plant.Servomotors.Fore_Arm_Servomotor.Uncontrolled_Servomotor.Gear_Box.O.w"
,
 "closedLoop_tuned/Plant/Servomotors/Fore Arm Servomotor/Uncontrolled Servomotor/Gear Box"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop_tuned/Plant/Servomotors/Fore Arm Servomotor/Uncontrolled Servomotor/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop_tuned/Plant/Servomotors/Fore Arm Servomotor" , 1U , 1U , "V" ,
1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
...
1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Plant.Servomotors.GA_R.w" , "closedLoop_tuned/Plant/Servomotors" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{ "Plant.Servomotors.Gripper_Servomotor.C.w" ,
"closedLoop_tuned/Plant/Servomotors/Gripper Servomotor" , 1U , 1U , "rad/s" ,
1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
...
"closedLoop_tuned/Plant/Servomotors/Gripper Servomotor/Uncontrolled Servomotor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
"Plant.Servomotors.Gripper_Servomotor.Uncontrolled_Servomotor.Gear_Box.O.w" ,
 "closedLoop_tuned/Plant/Servomotors/Gripper Servomotor/Uncontrolled Servomotor/Gear Box"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop_tuned/Plant/Servomotors/Gripper Servomotor/Uncontrolled Servomotor/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop_tuned/Plant/Servomotors/Gripper Servomotor" , 1U , 1U , "V" ,
1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
...
1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Plant.Servomotors.LFA_R.w" , "closedLoop_tuned/Plant/Servomotors" , 1U , 1U
, "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity"
, } , { "Plant.Servomotors.Left_Finger_Servomotor.C.w" ,
"closedLoop_tuned/Plant/Servomotors/Left Finger Servomotor" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
...
{ "Plant.Servomotors.Left_Finger_Servomotor.Uncontrolled_Servomotor.C.w" ,
 "closedLoop_tuned/Plant/Servomotors/Left Finger Servomotor/Uncontrolled Servomotor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
"Plant.Servomotors.Left_Finger_Servomotor.Uncontrolled_Servomotor.Gear_Box.O.w"
,
 "closedLoop_tuned/Plant/Servomotors/Left Finger Servomotor/Uncontrolled Servomotor/Gear Box"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop_tuned/Plant/Servomotors/Left Finger Servomotor/Uncontrolled Servomotor/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop_tuned/Plant/Servomotors/Left Finger Servomotor" , 1U , 1U , "V" ,
1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
...
"closedLoop_tuned/Plant/Servomotors/Mechanical Rotational Reference" , 1U ,
1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" ,
} , { "Plant.Servomotors.Mechanical_Rotational_Reference1.W.w" ,
"closedLoop_tuned/Plant/Servomotors/Mechanical Rotational Reference1" , 1U ,
1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" ,
} , { "Plant.Servomotors.Mechanical_Rotational_Reference2.W.w" ,
"closedLoop_tuned/Plant/Servomotors/Mechanical Rotational Reference2" , 1U ,
1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" ,
} , { "Plant.Servomotors.Mechanical_Rotational_Reference3.W.w" ,
"closedLoop_tuned/Plant/Servomotors/Mechanical Rotational Reference3" , 1U ,
1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" ,
} , { "Plant.Servomotors.Mechanical_Rotational_Reference4.W.w" ,
"closedLoop_tuned/Plant/Servomotors/Mechanical Rotational Reference4" , 1U ,
1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" ,
} , { "Plant.Servomotors.RFA_R.w" , "closedLoop_tuned/Plant/Servomotors" , 1U
, 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE
, FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , { "Plant.Servomotors.Right_Finger_Servomotor.C.w"
, "closedLoop_tuned/Plant/Servomotors/Right Finger Servomotor" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
...
{ "Plant.Servomotors.Right_Finger_Servomotor.Uncontrolled_Servomotor.C.w" ,
 "closedLoop_tuned/Plant/Servomotors/Right Finger Servomotor/Uncontrolled Servomotor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
"Plant.Servomotors.Right_Finger_Servomotor.Uncontrolled_Servomotor.Gear_Box.O.w"
,
 "closedLoop_tuned/Plant/Servomotors/Right Finger Servomotor/Uncontrolled Servomotor/Gear Box"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop_tuned/Plant/Servomotors/Right Finger Servomotor/Uncontrolled Servomotor/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop_tuned/Plant/Servomotors/Right Finger Servomotor" , 1U , 1U , "V"
, 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
...
, 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Plant.Servomotors.UA_R.w" , "closedLoop_tuned/Plant/Servomotors" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{ "Plant.Servomotors.Upper_Arm_Servomotor.C.w" ,
"closedLoop_tuned/Plant/Servomotors/Upper Arm Servomotor" , 1U , 1U , "rad/s"
, 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE
, NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
...
"Plant.Servomotors.Upper_Arm_Servomotor.Uncontrolled_Servomotor.C.w" ,
 "closedLoop_tuned/Plant/Servomotors/Upper Arm Servomotor/Uncontrolled Servomotor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
"Plant.Servomotors.Upper_Arm_Servomotor.Uncontrolled_Servomotor.Gear_Box.O.w"
,
 "closedLoop_tuned/Plant/Servomotors/Upper Arm Servomotor/Uncontrolled Servomotor/Gear Box"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop_tuned/Plant/Servomotors/Upper Arm Servomotor/Uncontrolled Servomotor/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop_tuned/Plant/Servomotors/Upper Arm Servomotor" , 1U , 1U , "V" ,
1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
...
1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Plant.Servomotors.WA_R.w" , "closedLoop_tuned/Plant/Servomotors" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{ "Plant.Servomotors.Wrist_Servomotor.C.w" ,
"closedLoop_tuned/Plant/Servomotors/Wrist Servomotor" , 1U , 1U , "rad/s" ,
1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
...
"closedLoop_tuned/Plant/Servomotors/Wrist Servomotor/Uncontrolled Servomotor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
"Plant.Servomotors.Wrist_Servomotor.Uncontrolled_Servomotor.Gear_Box.O.w" ,
 "closedLoop_tuned/Plant/Servomotors/Wrist Servomotor/Uncontrolled Servomotor/Gear Box"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop_tuned/Plant/Servomotors/Wrist Servomotor/Uncontrolled Servomotor/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop_tuned/Plant/Servomotors/Wrist Servomotor" , 1U , 1U , "V" ,
1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
...
1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Plant.Servomotors.x0.v" , "closedLoop_tuned/Plant/Servomotors" , 1U , 1U ,
"V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Plant.Servomotors.x1.v" , "closedLoop_tuned/Plant/Servomotors" , 1U , 1U ,
"V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Plant.Subsystem.Current_Sensor.I" ,
"closedLoop_tuned/Plant/Subsystem/Current Sensor" , 1U , 1U , "A" , 1.0e-6 ,
"A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "I" , } , {
"Plant.Subsystem.Current_Sensor.i1" ,
"closedLoop_tuned/Plant/Subsystem/Current Sensor" , 1U , 1U , "A" , 1.0e-6 ,
"A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current" , } , {
"Plant.Subsystem.Current_Sensor.n.v" ,
"closedLoop_tuned/Plant/Subsystem/Current Sensor" , 1U , 1U , "V" , 1.0e-6 ,
"V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"Plant.Subsystem.Current_Sensor.p.v" ,
"closedLoop_tuned/Plant/Subsystem/Current Sensor" , 1U , 1U , "V" , 1.0e-6 ,
"V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"Plant.Subsystem.Current_Sensor.v1" ,
"closedLoop_tuned/Plant/Subsystem/Current Sensor" , 1U , 1U , "V" , 1.0e-6 ,
"V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"Plant.Subsystem.x0.v" , "closedLoop_tuned/Plant/Subsystem" , 1U , 1U , "V" ,
1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Plant.Subsystem.x1.v" , "closedLoop_tuned/Plant/Subsystem" , 1U , 1U , "V" ,
1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } } ; static NeModeData *
s_major_mode_data = NULL ; static NeZCData s_zc_data [ 6 ] = { {
 "closedLoop_tuned/Plant/Servomotors/Fore Arm Servomotor/Uncontrolled Servomotor/Servomotor"
, 1U , 0U ,
...
mMDUY_P . mNumRow = 19 ; out -> mMDUY_P . mJc = ( int32_T * ) allocator ->
...
mMDXY_P . mNumRow = 19 ; out -> mMDXY_P . mJc = ( int32_T * ) allocator ->
...
mTDUY_P . mNumRow = 19 ; out -> mTDUY_P . mJc = ( int32_T * ) allocator ->
...
mTDXY_P . mNumRow = 19 ; out -> mTDXY_P . mJc = ( int32_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( int32_T ) , 31 ) ; out -> mTDXY_P . mIr = (
int32_T * ) allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 24 ) ;
...
allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 24 ) ; return out
; } static NeDsMethodOutput * ds_output_dxy ( const NeDynamicSystem * ds ,
PmAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mDXY . mN = 24 ; out -> mDXY . mX = (
real_T * ) allocator -> mCallocFcn ( allocator , sizeof ( real_T ) , 24 ) ;
...
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mLOG . mN = 311 ; out
-> mLOG . mX = ( real_T * ) allocator -> mCallocFcn ( allocator , sizeof (
real_T ) , 311 ) ; return out ; } static NeDsMethodOutput * ds_output_assert
( const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
...
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mOBS_EXP . mN = 311 ;
out -> mOBS_EXP . mX = ( real_T * ) allocator -> mCallocFcn ( allocator ,
sizeof ( real_T ) , 311 ) ; return out ; } static NeDsMethodOutput *
ds_output_obs_act ( const NeDynamicSystem * ds , PmAllocator * allocator ) {
NeDsMethodOutput * out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator
-> mCallocFcn ( allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out ->
mOBS_ACT . mN = 311 ; out -> mOBS_ACT . mX = ( real_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( real_T ) , 311 ) ; return out ; } static
NeDsMethodOutput * ds_output_obs_all ( const NeDynamicSystem * ds ,
PmAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mOBS_ALL . mN = 311 ; out -> mOBS_ALL . mX
= ( real_T * ) allocator -> mCallocFcn ( allocator , sizeof ( real_T ) , 311
) ; return out ; } static NeDsMethodOutput * ds_output_obs_il ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mOBS_IL . mN = 311 ; out ->
mOBS_IL . mX = ( boolean_T * ) allocator -> mCallocFcn ( allocator , sizeof (
boolean_T ) , 311 ) ; return out ; } static NeDsMethodOutput * ds_output_dp_l
( const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
...
-> mN ) ; } NeDynamicSystem * closedLoop_tuned_57a28c5_2_dae_ds ( PmAllocator
* allocator ) { NeDynamicSystem * ds ; _NeDynamicSystem * _ds ; static
NeDsIoInfo input_info [ 12 ] ; static NeDsIoInfo output_info [ 19 ] ; _ds = (
...
mNumObservables = 311 ; ds -> mNumObservableElements = 311 ; ds -> mNumZcs =
...
input_info ; ds -> mNumIo [ NE_OUTPUT_IO_TYPE ] = 19 ; output_info [ 0 ] .
mIdentifier =
 "Plant.Robot.Gripper.Torque_Actuated_Revolute_Joint_with_Position1.Rot2Rev.Ideal_Torque_Sensor.T"
...
"Plant.Subsystem.Current_Sensor.I" ; output_info [ 18 ] . mM = 1 ;
output_info [ 18 ] . mN = 1 ; output_info [ 18 ] . mName =
"Plant.Subsystem.Current_Sensor.I" ; output_info [ 18 ] . mUnit = "A" ; ds ->
...
[ NE_DS_METHOD_M_P ] = closedLoop_tuned_57a28c5_2_ds_m_p ; ds -> mMakeOutput
[ NE_DS_METHOD_M_P ] = ds_output_m_p ; ds -> mMethods [ NE_DS_METHOD_M ] =
ds_m ; ds -> mMakeOutput [ NE_DS_METHOD_M ] = ds_output_m ; ds -> mMethods [
...
closedLoop_tuned_57a28c5_2_ds_a_p ; ds -> mMakeOutput [ NE_DS_METHOD_A_P ] =
ds_output_a_p ; ds -> mMethods [ NE_DS_METHOD_A ] =
closedLoop_tuned_57a28c5_2_ds_a ; ds -> mMakeOutput [ NE_DS_METHOD_A ] =
...
NE_DS_METHOD_F ] = closedLoop_tuned_57a28c5_2_ds_f ; ds -> mMakeOutput [
...
NE_DS_METHOD_DXF_P ] = closedLoop_tuned_57a28c5_2_ds_dxf_p ; ds ->
mMakeOutput [ NE_DS_METHOD_DXF_P ] = ds_output_dxf_p ; ds -> mMethods [
NE_DS_METHOD_DXF ] = closedLoop_tuned_57a28c5_2_ds_dxf ; ds -> mMakeOutput [
...
NE_DS_METHOD_TDXF_P ] = closedLoop_tuned_57a28c5_2_ds_tdxf_p ; ds ->
mMakeOutput [ NE_DS_METHOD_TDXF_P ] = ds_output_tdxf_p ; ds -> mMethods [
NE_DS_METHOD_DNF_P ] = closedLoop_tuned_57a28c5_2_ds_dnf_p ; ds ->
...
closedLoop_tuned_57a28c5_2_ds_tdxy_p ; ds -> mMakeOutput [
NE_DS_METHOD_TDXY_P ] = ds_output_tdxy_p ; ds -> mMethods [ NE_DS_METHOD_Y ]
= closedLoop_tuned_57a28c5_2_ds_y ; ds -> mMakeOutput [ NE_DS_METHOD_Y ] =
ds_output_y ; ds -> mMethods [ NE_DS_METHOD_DXY_P ] =
closedLoop_tuned_57a28c5_2_ds_dxy_p ; ds -> mMakeOutput [ NE_DS_METHOD_DXY_P
...
NE_DS_METHOD_MODE ] = closedLoop_tuned_57a28c5_2_ds_mode ; ds -> mMakeOutput
[ NE_DS_METHOD_MODE ] = ds_output_mode ; ds -> mMethods [ NE_DS_METHOD_ZC ] =
closedLoop_tuned_57a28c5_2_ds_zc ; ds -> mMakeOutput [ NE_DS_METHOD_ZC ] =
...
NE_DS_METHOD_LOG ] = closedLoop_tuned_57a28c5_2_ds_log ; ds -> mMakeOutput [
...
mMethods [ NE_DS_METHOD_OBS_ACT ] = closedLoop_tuned_57a28c5_2_ds_obs_act ;
ds -> mMakeOutput [ NE_DS_METHOD_OBS_ACT ] = ds_output_obs_act ; ds ->
mMethods [ NE_DS_METHOD_OBS_ALL ] = closedLoop_tuned_57a28c5_2_ds_obs_all ;
ds -> mMakeOutput [ NE_DS_METHOD_OBS_ALL ] = ds_output_obs_all ; ds ->
mMethods [ NE_DS_METHOD_OBS_IL ] = closedLoop_tuned_57a28c5_2_ds_obs_il ; ds
...
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmRealVector out ;
real_T t0 [ 311 ] ; int32_T b ; ( void ) t1 ; out = t2 -> mOBS_EXP ; for ( b
= 0 ; b < 311 ; b ++ ) { t0 [ b ] = 0.0 ; } for ( b = 0 ; b < 311 ; b ++ ) {
...
18 ] = 1.0 ; out . mX [ 19 ] = 1.0 ; out . mX [ 20 ] = 1.0 ; out . mX [ 21 ]
= 1.0 ; out . mX [ 22 ] = 1.0 ; out . mX [ 23 ] = 1.0 ; ( void ) sys ; ( void
) t2 ; return 0 ; } static int32_T ds_duy ( const NeDynamicSystem * sys ,
const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { ( void ) t1 ; (
void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_duy_p ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 -> mDUY_P ; out .
mNumCol = 12ULL ; out . mNumRow = 19ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1
] = 0 ; out . mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 0 ; out
. mJc [ 5 ] = 0 ; out . mJc [ 6 ] = 0 ; out . mJc [ 7 ] = 0 ; out . mJc [ 8 ]
= 0 ; out . mJc [ 9 ] = 0 ; out . mJc [ 10 ] = 0 ; out . mJc [ 11 ] = 0 ; out
. mJc [ 12 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T
ds_mduy_p ( const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mMDUY_P ; out . mNumCol = 12ULL ; out . mNumRow = 19ULL ; out . mJc [ 0 ] = 0
; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 0 ; out . mJc
[ 4 ] = 0 ; out . mJc [ 5 ] = 0 ; out . mJc [ 6 ] = 0 ; out . mJc [ 7 ] = 0 ;
out . mJc [ 8 ] = 0 ; out . mJc [ 9 ] = 0 ; out . mJc [ 10 ] = 0 ; out . mJc
[ 11 ] = 0 ; out . mJc [ 12 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; }
...
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mMDXY_P ; out . mNumCol = 30ULL ; out . mNumRow =
19ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ; out
. mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 0 ; out . mJc [ 5 ] = 0 ; out . mJc [ 6 ]
= 0 ; out . mJc [ 7 ] = 0 ; out . mJc [ 8 ] = 0 ; out . mJc [ 9 ] = 0 ; out .
mJc [ 10 ] = 0 ; out . mJc [ 11 ] = 0 ; out . mJc [ 12 ] = 0 ; out . mJc [ 13
] = 0 ; out . mJc [ 14 ] = 0 ; out . mJc [ 15 ] = 0 ; out . mJc [ 16 ] = 0 ;
...
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mTDUY_P ; out . mNumCol = 12ULL ; out . mNumRow = 19ULL ; out . mJc [ 0 ] = 0
; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 0 ; out . mJc
[ 4 ] = 0 ; out . mJc [ 5 ] = 0 ; out . mJc [ 6 ] = 0 ; out . mJc [ 7 ] = 0 ;
out . mJc [ 8 ] = 0 ; out . mJc [ 9 ] = 0 ; out . mJc [ 10 ] = 0 ; out . mJc
[ 11 ] = 0 ; out . mJc [ 12 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; }
...
mNumCol = 1ULL ; out . mNumRow = 19ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1
