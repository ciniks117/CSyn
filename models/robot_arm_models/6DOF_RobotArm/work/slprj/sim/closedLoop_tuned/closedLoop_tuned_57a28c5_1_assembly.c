...
boolean_T closedLoop_tuned_57a28c5_1_getTargetStatus ( const
RuntimeDerivedValuesBundle * rtdv , const double * state , const size_t
targetIndex ) { return true ; } void closedLoop_tuned_57a28c5_1_setTargets (
const RuntimeDerivedValuesBundle * rtdv , CTarget * targets ) { ( void ) rtdv
; ( void ) targets ; } void closedLoop_tuned_57a28c5_1_resetStateVector (
...
0 ] ; } static PmfMessageId initializeTrackedAngleState_0 ( const
...
closedLoop_tuned_57a28c5_1_initializeTrackedAngleState ( const void * mech ,
...
void closedLoop_tuned_57a28c5_1_computeDiscreteState ( const void * mech ,
...
} void closedLoop_tuned_57a28c5_1_adjustPosition ( const void * mech , const
...
dofDeltas [ 8 ] ; state [ 18 ] = state [ 18 ] + dofDeltas [ 9 ] ; } static
...
closedLoop_tuned_57a28c5_1_perturbJointPrimitiveState ( const void * mech ,
...
closedLoop_tuned_57a28c5_1_perturbFlexibleBodyState ( const void * mech ,
...
closedLoop_tuned_57a28c5_1_computeDofBlendMatrix ( const void * mech , size_t
...
primIdx ) ) { } } void closedLoop_tuned_57a28c5_1_projectPartiallyTargetedPos
...
closedLoop_tuned_57a28c5_1_propagateMotion ( const void * mech , const
...
} size_t closedLoop_tuned_57a28c5_1_computeAssemblyError ( const void * mech
, const RuntimeDerivedValuesBundle * rtdv , size_t constraintIdx , const
...
closedLoop_tuned_57a28c5_1_computeAssemblyJacobian ( const void * mech ,
...
closedLoop_tuned_57a28c5_1_computeFullAssemblyJacobian ( const void * mech ,
const RuntimeDerivedValuesBundle * rtdv , const double * state , const double
* motionData , double * J ) { const double * rtdvd = rtdv -> mDoubles .
...
closedLoop_tuned_57a28c5_1_isInKinematicSingularity ( const void * mech ,
...
) ; } return 0 ; } PmfMessageId closedLoop_tuned_57a28c5_1_convertStateVector
...
closedLoop_tuned_57a28c5_1_constructStateVector ( const void * mech , const
...
closedLoop_tuned_57a28c5_1_extractSolverStateVector ( const void * mech ,
...
] = fullState [ 23 ] ; } int closedLoop_tuned_57a28c5_1_isPositionViolation (
...
return ii [ 1 ] ; } int closedLoop_tuned_57a28c5_1_isVelocityViolation (
const void * mech , const RuntimeDerivedValuesBundle * rtdv , const int *
eqnEnableFlags , const double * state ) { const double * rtdvd = rtdv ->
mDoubles . mValues ; const int * rtdvi = rtdv -> mInts . mValues ; int ii [ 3
...
ii [ 1 ] ; } PmfMessageId closedLoop_tuned_57a28c5_1_projectStateSim ( const
...
"sm:compiler:messages:simulationErrors:ConstraintViolation" ,
 "'closedLoop_tuned/Plant/Robot/Gripper/Left Finger Revolute B' kinematic constraints cannot be maintained. Check solver type and consistency tolerance in the Simscape Solver Configuration block. Check Simulink solver type and tolerances in Model Configuration Parameters. A kinematic singularity might be the source of this problem."
, neDiagMgr ) ; } case 3 : case 4 : case 5 : { return
sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:ConstraintViolation" ,
 "'closedLoop_tuned/Plant/Robot/Gripper/Right Finger Revolute B' kinematic constraints cannot be maintained. Check solver type and consistency tolerance in the Simscape Solver Configuration block. Check Simulink solver type and tolerances in Model Configuration Parameters. A kinematic singularity might be the source of this problem."
