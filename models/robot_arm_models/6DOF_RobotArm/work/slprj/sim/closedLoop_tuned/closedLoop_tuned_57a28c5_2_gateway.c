...
#endif
#include "nesl_rtw.h"
#include "closedLoop_tuned_57a28c5_2.h"
void closedLoop_tuned_57a28c5_2_gateway ( void ) { NeModelParameters
...
closedLoop_tuned_57a28c5_2_dae ( & dae , & modelparams , & solverparams ) ;
nesl_register_simulator_group (
"closedLoop_tuned/Plant/Robot/Solver Configuration_2" , 1 , & dae , &
