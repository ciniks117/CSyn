...
#endif
#include "nesl_rtw.h"
#include "closedLoop_2f6391d8_2.h"
void closedLoop_2f6391d8_2_gateway ( void ) { NeModelParameters modelparams =
...
closedLoop_2f6391d8_2_dae ( & dae , & modelparams , & solverparams ) ;
nesl_register_simulator_group (
"closedLoop/Plant/Robot/Solver Configuration_2" , 1 , & dae , & solverparams
