...
void closedLoop_2f6391d8_1_computeConstraintError ( const void * mech , const
RuntimeDerivedValuesBundle * rtdv , const double * state , double * error ) {
const double * rtdvd = rtdv -> mDoubles . mValues ; const int * rtdvi = rtdv
-> mInts . mValues ; double xx [ 58 ] ; ( void ) mech ; ( void ) rtdvd ; (
void ) rtdvi ; xx [ 0 ] = - 0.99302022896367 ; xx [ 1 ] = 0.1066412368322485
; xx [ 2 ] = - 0.03120900126866927 ; xx [ 3 ] = - 0.03955337805600653 ; xx [
4 ] = 0.5 ; xx [ 5 ] = xx [ 4 ] * state [ 8 ] ; xx [ 6 ] = sin ( xx [ 5 ] ) ;
xx [ 7 ] = cos ( xx [ 5 ] ) ; xx [ 8 ] = 0.07189840968753769 * xx [ 6 ] ; xx
[ 9 ] = 0.9741263695734882 * xx [ 6 ] ; xx [ 10 ] = 0.2142625370567126 * xx [
6 ] ; pm_math_quatCompose ( xx + 0 , xx + 7 , xx + 11 ) ; xx [ 0 ] =
