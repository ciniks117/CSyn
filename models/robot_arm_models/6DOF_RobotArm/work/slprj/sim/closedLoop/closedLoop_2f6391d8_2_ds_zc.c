...
int32_T closedLoop_2f6391d8_2_ds_zc ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t49 , NeDsMethodOutput * t50 ) { PmRealVector out ;
...
t50 -> mZC ; nonscalar0 [ 0 ] = - 523.59877559829886 ; nonscalar0 [ 1 ] = -
