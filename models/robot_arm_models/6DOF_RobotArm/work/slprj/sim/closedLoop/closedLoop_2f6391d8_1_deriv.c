...
rtdv , const int * eqnEnableFlags , const double * state , const double *
...
* rtdvi = rtdv -> mInts . mValues ; int ii [ 6 ] ; double xx [ 773 ] ; ( void
) rtdvd ; ( void ) rtdvi ; ( void ) eqnEnableFlags ; ( void ) inputDot ; (
void ) inputDdot ; ( void ) discreteState ; ( void ) neDiagMgr ; xx [ 0 ] =
0.03504158251691365 ; xx [ 1 ] = 0.9993858551604131 ; xx [ 2 ] =
9.258035449377644e-9 ; xx [ 3 ] = - xx [ 0 ] ; xx [ 4 ] = xx [ 1 ] ; xx [ 5 ]
= - xx [ 2 ] ; xx [ 6 ] = xx [ 0 ] * state [ 1 ] ; xx [ 7 ] = xx [ 1 ] *
state [ 1 ] ; xx [ 8 ] = xx [ 2 ] * state [ 1 ] ; xx [ 9 ] = - xx [ 6 ] ; xx
[ 10 ] = xx [ 7 ] ; xx [ 11 ] = - xx [ 8 ] ; xx [ 12 ] = 6.523245204659643e-4
; xx [ 13 ] = 2.479367537855924e-3 ; xx [ 14 ] = 2.357448869664163e-3 ; xx [
15 ] = - ( xx [ 12 ] * xx [ 6 ] ) ; xx [ 16 ] = xx [ 13 ] * xx [ 7 ] ; xx [
17 ] = - ( xx [ 14 ] * xx [ 8 ] ) ; pm_math_cross3 ( xx + 9 , xx + 15 , xx +
6 ) ; xx [ 15 ] = - 0.9998475545126857 ; xx [ 16 ] = 4.62807808743193e-9 ; xx
[ 17 ] = 1.445651376386081e-10 ; xx [ 18 ] = - 0.01746046205007074 ; xx [ 19
] = 0.5 ; xx [ 20 ] = xx [ 19 ] * state [ 2 ] ; xx [ 21 ] =
1.260590941853934e-4 ; xx [ 22 ] = sin ( xx [ 20 ] ) ; xx [ 23 ] =
0.9999999920545524 ; xx [ 24 ] = 1.774136393351e-12 ; xx [ 25 ] = cos ( xx [
20 ] ) ; xx [ 26 ] = - ( xx [ 21 ] * xx [ 22 ] ) ; xx [ 27 ] = xx [ 23 ] * xx
[ 22 ] ; xx [ 28 ] = xx [ 24 ] * xx [ 22 ] ; pm_math_quatCompose ( xx + 15 ,
xx + 25 , xx + 29 ) ; pm_math_quatInverseXform ( xx + 29 , xx + 9 , xx + 15 )
; xx [ 18 ] = xx [ 21 ] * state [ 3 ] ; xx [ 20 ] = xx [ 15 ] - xx [ 18 ] ;
xx [ 22 ] = xx [ 23 ] * state [ 3 ] ; xx [ 25 ] = xx [ 16 ] + xx [ 22 ] ; xx
[ 26 ] = xx [ 24 ] * state [ 3 ] ; xx [ 27 ] = xx [ 17 ] + xx [ 26 ] ; xx [
33 ] = xx [ 20 ] ; xx [ 34 ] = xx [ 25 ] ; xx [ 35 ] = xx [ 27 ] ; xx [ 28 ]
= 2.569466215527473e-4 ; xx [ 36 ] = 1.173285990167339e-3 ; xx [ 37 ] =
1.08989429237583e-3 ; xx [ 38 ] = xx [ 20 ] * xx [ 28 ] ; xx [ 39 ] = xx [ 25
] * xx [ 36 ] ; xx [ 40 ] = xx [ 27 ] * xx [ 37 ] ; pm_math_cross3 ( xx + 33
, xx + 38 , xx + 41 ) ; xx [ 44 ] = - 0.9999999980191991 ; xx [ 45 ] =
2.23856606067822e-7 ; xx [ 46 ] = - 3.321689057863772e-8 ; xx [ 47 ] = -
6.294084901737286e-5 ; xx [ 38 ] = xx [ 19 ] * state [ 4 ] ; xx [ 39 ] =
6.646453320689627e-8 ; xx [ 40 ] = sin ( xx [ 38 ] ) ; xx [ 48 ] =
4.477090296885221e-7 ; xx [ 49 ] = cos ( xx [ 38 ] ) ; xx [ 50 ] = - ( xx [
39 ] * xx [ 40 ] ) ; xx [ 51 ] = - ( xx [ 48 ] * xx [ 40 ] ) ; xx [ 52 ] = xx
[ 40 ] ; pm_math_quatCompose ( xx + 44 , xx + 49 , xx + 53 ) ;
pm_math_quatInverseXform ( xx + 53 , xx + 33 , xx + 44 ) ; xx [ 38 ] = xx [
39 ] * state [ 5 ] ; xx [ 40 ] = xx [ 44 ] - xx [ 38 ] ; xx [ 47 ] = xx [ 48
] * state [ 5 ] ; xx [ 49 ] = xx [ 45 ] - xx [ 47 ] ; xx [ 50 ] = xx [ 46 ] +
state [ 5 ] ; xx [ 57 ] = xx [ 40 ] ; xx [ 58 ] = xx [ 49 ] ; xx [ 59 ] = xx
[ 50 ] ; xx [ 51 ] = 2.710685289829154e-5 ; xx [ 52 ] = 4.63033976639681e-5 ;
xx [ 60 ] = 3.87938357019707e-5 ; xx [ 61 ] = xx [ 40 ] * xx [ 51 ] ; xx [ 62
] = xx [ 49 ] * xx [ 52 ] ; xx [ 63 ] = xx [ 50 ] * xx [ 60 ] ;
pm_math_cross3 ( xx + 57 , xx + 61 , xx + 64 ) ; xx [ 67 ] = -
...
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop/Plant/Robot/Gripper/Left Finger Revolute  A' has a degenerate mass distribution on its follower side."
...
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop/Plant/Robot/Gripper/Left Revolute A' has a degenerate mass distribution on its follower side."
...
return sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop/Plant/Robot/Gripper/Torque Actuated Revolute Joint with Position1/Upper Arm Revolute' has a degenerate mass distribution on its follower side."
...
return sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop/Plant/Robot/Gripper/Torque Actuated Revolute Joint with Position3/Upper Arm Revolute' has a degenerate mass distribution on its follower side."
...
0 ) { return sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop/Plant/Robot/Gripper/Right Finger Revolute A' has a degenerate mass distribution on its follower side."
...
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop/Plant/Robot/Gripper/Right Revolute A' has a degenerate mass distribution on its follower side."
...
!= 0 ) { return sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop/Plant/Robot/Torque Actuated Revolute Joint with Position3/Upper Arm Revolute' has a degenerate mass distribution on its follower side."
...
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop/Plant/Robot/Torque Actuated Revolute Joint with Position2/Upper Arm Revolute' has a degenerate mass distribution on its follower side."
...
!= 0 ) { return sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop/Plant/Robot/Torque Actuated Revolute Joint with Position1/Upper Arm Revolute' has a degenerate mass distribution on its follower side."
...
return sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop/Plant/Robot/Torque Actuated Revolute Joint with Position/Upper Arm Revolute' has a degenerate mass distribution on its follower side."
