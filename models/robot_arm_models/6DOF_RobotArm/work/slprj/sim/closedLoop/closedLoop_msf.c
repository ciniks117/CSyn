...
#define S_FUNCTION_NAME closedLoop_msf
#endif
...
fileName ; } void scblock ( SimStruct * S ) { ( void ) S ; }
...
ssGetMassMatrixPr ( S ) ; }
#endif
static void mdlInitializeConditions ( SimStruct * S ) { bmtszmiqmi ( ) ; }
static void mdlReset ( SimStruct * S ) { ddc0t4t15d ( ) ; } static void
mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { const real_T *
i_dxtks3rxbo = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; const real_T *
i_hockf2jmgv = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; const real_T *
i_jqnudpgud0 = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; const real_T *
i_pagjncyafa = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; const real_T *
i_hjcfzodrwq = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; const real_T *
i_ex5zsiebjd = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T * o_B_1_1
...
ssGetContStates ( S ) ; if ( tid == 0 ) { closedLoop ( i_dxtks3rxbo ,
i_hockf2jmgv , i_jqnudpgud0 , i_pagjncyafa , i_hjcfzodrwq , i_ex5zsiebjd ,
o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , o_B_1_6 , localX_ ) ;
a5w1dgbmqf ( localX_ ) ; } } static void mdlInitializeSizes ( SimStruct * S )
...
mr_closedLoop_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S , 2 )
...
false ) ; ssRegisterMsgForNotSupportingMultiExecInst ( S ,
 "<diag_root><diag id=\"Simulink:blocks:BlockDoesNotSupportMultiExecInstances\" pr=\"d\"><arguments><arg type=\"encoded\">YwBsAG8AcwBlAGQATABvAG8AcAAvAFAAbABhAG4AdAAvAFIAbwBiAG8AdAAvAFMAYwBvAHAAZQAgAC8AUwAtAEYAdQBuAGMAdABpAG8AbgAAAA==</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAACsCr4ED+</h></hs></diag></diag_root>"
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_closedLoop_MdlInfoRegFcn
( S , "closedLoop" , & retVal ) ; if ( ! retVal ) return ; }
#endif
...
sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } iqau2xj2y1 ( S ,
...
ssSetModelMappingInfoPtr ( S , & ( ope1wg3cbz . rtm . DataMapInfo . mmi ) ) ;
if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S ->
mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { real_T * localX_ = ( real_T * )
ssGetContStates ( S ) ; lu22svnl5z ( localX_ ) ; } static void mdlOutputs (
SimStruct * S , int_T tid ) { const real_T * i_dxtks3rxbo = ( real_T * )
ssGetInputPortSignal ( S , 0 ) ; const real_T * i_hockf2jmgv = ( real_T * )
ssGetInputPortSignal ( S , 1 ) ; const real_T * i_jqnudpgud0 = ( real_T * )
ssGetInputPortSignal ( S , 2 ) ; const real_T * i_pagjncyafa = ( real_T * )
ssGetInputPortSignal ( S , 3 ) ; const real_T * i_hjcfzodrwq = ( real_T * )
ssGetInputPortSignal ( S , 4 ) ; const real_T * i_ex5zsiebjd = ( real_T * )
...
( S ) ; ci0rchb45g ( localX_ , localXdot_ ) ; }
#define MDL_MASSMATRIX
static void mdlMassMatrix ( SimStruct * S ) { real_T * localX_ = ( real_T * )
ssGetContStates ( S ) ; kja25six4i ( localX_ ) ; } static void mdlTerminate (
SimStruct * S ) { cnzzkdsgp5 ( ) ; return ; }
#define MDL_CLEANUP_RUNTIME_RESOURCES
static void mdlCleanupRuntimeResources ( SimStruct * S ) { i51jvolrrc ( ) ; }
...
mxArray * mdlrefDW = mr_closedLoop_GetDWork ( ) ; mxSetFieldByNumber ( ss , 0
, 1 , mdlrefDW ) ; } { mxArray * data =
mr_closedLoop_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss , 0 ,
...
( localX , & rawData [ 0 ] , numBytes ) ; } mr_closedLoop_SetDWork (
