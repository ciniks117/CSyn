...
boolean_T closedLoop_2f6391d8_1_getTargetStatus ( const
RuntimeDerivedValuesBundle * rtdv , const double * state , const size_t
targetIndex ) { return true ; } void closedLoop_2f6391d8_1_setTargets ( const
RuntimeDerivedValuesBundle * rtdv , CTarget * targets ) { ( void ) rtdv ; (
void ) targets ; } void closedLoop_2f6391d8_1_resetStateVector ( const void *
...
RuntimeDerivedValuesBundle * rtdv , const double * motionData , double *
state , NeuDiagnosticManager * neDiagMgr ) { const double * rtdvd = rtdv ->
mDoubles . mValues ; const int * rtdvi = rtdv -> mInts . mValues ; double xx
[ 19 ] ; ( void ) rtdvd ; ( void ) rtdvi ; ( void ) neDiagMgr ; xx [ 0 ] =
3.393780417072501e-4 ; xx [ 1 ] = 0.1217147440922071 ; xx [ 2 ] =
2.437305475440299e-3 ; xx [ 3 ] = - 0.9925620713260872 ; xx [ 4 ] =
motionData [ 42 ] ; xx [ 5 ] = motionData [ 43 ] ; xx [ 6 ] = motionData [ 44
] ; xx [ 7 ] = motionData [ 45 ] ; xx [ 8 ] = motionData [ 70 ] ; xx [ 9 ] =
motionData [ 71 ] ; xx [ 10 ] = motionData [ 72 ] ; xx [ 11 ] = motionData [
73 ] ; pm_math_quatInverseCompose ( xx + 4 , xx + 8 , xx + 12 ) ;
pm_math_quatInverseCompose ( xx + 0 , xx + 12 , xx + 4 ) ; xx [ 0 ] =
8.039551964356129e-5 ; xx [ 1 ] = 0.9999878887291285 ; xx [ 2 ] =
4.920968565308659e-3 ; xx [ 8 ] = motionData [ 120 ] ; xx [ 9 ] = motionData
[ 121 ] ; xx [ 10 ] = motionData [ 122 ] ; pm_math_quatInverseXform ( xx + 12
, xx + 8 , xx + 16 ) ; xx [ 8 ] = motionData [ 114 ] - xx [ 16 ] ; xx [ 9 ] =
motionData [ 115 ] - xx [ 17 ] ; xx [ 10 ] = motionData [ 116 ] - xx [ 18 ] ;
state [ 20 ] = sm_core_canonicalAngle ( 2.0 * atan2 ( sqrt ( xx [ 5 ] * xx [
5 ] + xx [ 6 ] * xx [ 6 ] + xx [ 7 ] * xx [ 7 ] ) , fabs ( xx [ 4 ] ) ) * ( (
pm_math_dot3 ( xx + 5 , xx + 0 ) * xx [ 4 ] ) < 0.0 ? - 1.0 : + 1.0 ) ) ;
state [ 21 ] = pm_math_dot3 ( xx + 8 , xx + 0 ) ; return NULL ; } static
PmfMessageId initializeTrackedAngleState_1 ( const RuntimeDerivedValuesBundle
* rtdv , const double * motionData , double * state , NeuDiagnosticManager *
neDiagMgr ) { const double * rtdvd = rtdv -> mDoubles . mValues ; const int *
rtdvi = rtdv -> mInts . mValues ; double xx [ 19 ] ; ( void ) rtdvd ; ( void
) rtdvi ; ( void ) neDiagMgr ; xx [ 0 ] = - 0.9925620713260874 ; xx [ 1 ] =
...
closedLoop_2f6391d8_1_initializeTrackedAngleState ( const void * mech , const
RuntimeDerivedValuesBundle * rtdv , const double * motionData , double *
...
void closedLoop_2f6391d8_1_computeDiscreteState ( const void * mech , const
...
closedLoop_2f6391d8_1_adjustPosition ( const void * mech , const double *
...
[ 8 ] ; state [ 18 ] = state [ 18 ] + dofDeltas [ 9 ] ; } static void
perturbJointPrimitiveState_0_0 ( double mag , double * state ) { state [ 0 ]
= state [ 0 ] + mag ; } static void perturbJointPrimitiveState_0_0v ( double
mag , double * state ) { state [ 0 ] = state [ 0 ] + mag ; state [ 1 ] =
state [ 1 ] - 0.875 * mag ; } static void perturbJointPrimitiveState_1_0 (
double mag , double * state ) { state [ 2 ] = state [ 2 ] + mag ; } static
void perturbJointPrimitiveState_1_0v ( double mag , double * state ) { state
[ 2 ] = state [ 2 ] + mag ; state [ 3 ] = state [ 3 ] - 0.875 * mag ; }
static void perturbJointPrimitiveState_2_0 ( double mag , double * state ) {
state [ 4 ] = state [ 4 ] + mag ; } static void
perturbJointPrimitiveState_2_0v ( double mag , double * state ) { state [ 4 ]
= state [ 4 ] + mag ; state [ 5 ] = state [ 5 ] - 0.875 * mag ; } static void
perturbJointPrimitiveState_3_0 ( double mag , double * state ) { state [ 6 ]
= state [ 6 ] + mag ; } static void perturbJointPrimitiveState_3_0v ( double
mag , double * state ) { state [ 6 ] = state [ 6 ] + mag ; state [ 7 ] =
state [ 7 ] - 0.875 * mag ; } static void perturbJointPrimitiveState_4_0 (
double mag , double * state ) { state [ 8 ] = state [ 8 ] + mag ; } static
void perturbJointPrimitiveState_4_0v ( double mag , double * state ) { state
[ 8 ] = state [ 8 ] + mag ; state [ 9 ] = state [ 9 ] - 0.875 * mag ; }
static void perturbJointPrimitiveState_5_0 ( double mag , double * state ) {
state [ 10 ] = state [ 10 ] + mag ; } static void
perturbJointPrimitiveState_5_0v ( double mag , double * state ) { state [ 10
] = state [ 10 ] + mag ; state [ 11 ] = state [ 11 ] - 0.875 * mag ; } static
void perturbJointPrimitiveState_6_0 ( double mag , double * state ) { state [
12 ] = state [ 12 ] + mag ; } static void perturbJointPrimitiveState_6_0v (
double mag , double * state ) { state [ 12 ] = state [ 12 ] + mag ; state [
13 ] = state [ 13 ] - 0.875 * mag ; } static void
perturbJointPrimitiveState_7_0 ( double mag , double * state ) { state [ 14 ]
= state [ 14 ] + mag ; } static void perturbJointPrimitiveState_7_0v ( double
mag , double * state ) { state [ 14 ] = state [ 14 ] + mag ; state [ 15 ] =
state [ 15 ] - 0.875 * mag ; } static void perturbJointPrimitiveState_8_0 (
double mag , double * state ) { state [ 16 ] = state [ 16 ] + mag ; } static
void perturbJointPrimitiveState_8_0v ( double mag , double * state ) { state
...
perturbJointPrimitiveState_9_0v ( double mag , double * state ) { state [ 18
] = state [ 18 ] + mag ; state [ 19 ] = state [ 19 ] - 0.875 * mag ; } void
closedLoop_2f6391d8_1_perturbJointPrimitiveState ( const void * mech , size_t
...
closedLoop_2f6391d8_1_perturbFlexibleBodyState ( const void * mech , size_t
...
} void closedLoop_2f6391d8_1_computeDofBlendMatrix ( const void * mech ,
...
6 + primIdx ) ) { } } void closedLoop_2f6391d8_1_projectPartiallyTargetedPos
...
closedLoop_2f6391d8_1_propagateMotion ( const void * mech , const
...
} size_t closedLoop_2f6391d8_1_computeAssemblyError ( const void * mech ,
...
motionData , error ) ; case 1 : return computeAssemblyError_1 ( rtdv , state
, motionData , error ) ; } return 0 ; } static size_t
...
0.021844 ; return 5 ; } size_t closedLoop_2f6391d8_1_computeAssemblyJacobian
( const void * mech , const RuntimeDerivedValuesBundle * rtdv , size_t
constraintIdx , boolean_T forVelocitySatisfaction , const double * state ,
const double * motionData , double * J ) { ( void ) mech ; ( void ) rtdv ; (
void ) state ; ( void ) forVelocitySatisfaction ; ( void ) motionData ; (
void ) J ; switch ( constraintIdx ) { case 0 : return
computeAssemblyJacobian_0 ( rtdv , state , motionData , J ) ; case 1 : return
computeAssemblyJacobian_1 ( rtdv , state , motionData , J ) ; } return 0 ; }
size_t closedLoop_2f6391d8_1_computeFullAssemblyJacobian ( const void * mech
...
closedLoop_2f6391d8_1_isInKinematicSingularity ( const void * mech , const
...
) ; } return 0 ; } PmfMessageId closedLoop_2f6391d8_1_convertStateVector (
...
NeuDiagnosticManager * ) neDiagMgr0 ; ( void ) asmMech ; ( void ) rtdvd ; (
void ) rtdvi ; ( void ) simMech ; ( void ) neDiagMgr ; simState [ 0 ] =
asmState [ 0 ] ; simState [ 1 ] = asmState [ 1 ] ; simState [ 2 ] = asmState
[ 2 ] ; simState [ 3 ] = asmState [ 3 ] ; simState [ 4 ] = asmState [ 4 ] ;
simState [ 5 ] = asmState [ 5 ] ; simState [ 6 ] = asmState [ 6 ] ; simState
[ 7 ] = asmState [ 7 ] ; simState [ 8 ] = asmState [ 8 ] ; simState [ 9 ] =
asmState [ 9 ] ; simState [ 10 ] = asmState [ 10 ] ; simState [ 11 ] =
asmState [ 11 ] ; simState [ 12 ] = asmState [ 12 ] ; simState [ 13 ] =
asmState [ 13 ] ; simState [ 14 ] = asmState [ 14 ] ; simState [ 15 ] =
asmState [ 15 ] ; simState [ 16 ] = asmState [ 16 ] ; simState [ 17 ] =
asmState [ 17 ] ; simState [ 18 ] = asmState [ 18 ] ; simState [ 19 ] =
asmState [ 19 ] ; simState [ 20 ] = asmState [ 20 ] ; simState [ 21 ] =
asmState [ 21 ] ; simState [ 22 ] = asmState [ 22 ] ; simState [ 23 ] =
asmState [ 23 ] ; return NULL ; } void
closedLoop_2f6391d8_1_constructStateVector ( const void * mech , const double
* solverState , const double * u , const double * uDot , double *
...
closedLoop_2f6391d8_1_extractSolverStateVector ( const void * mech , const
...
] ; } int closedLoop_2f6391d8_1_isPositionViolation ( const void * mech ,
...
int * rtdvi = rtdv -> mInts . mValues ; int ii [ 3 ] ; double xx [ 58 ] ; (
void ) mech ; ( void ) rtdvd ; ( void ) rtdvi ; ( void ) eqnEnableFlags ; xx
[ 0 ] = - 0.99302022896367 ; xx [ 1 ] = 0.1066412368322485 ; xx [ 2 ] = -
0.03120900126866927 ; xx [ 3 ] = - 0.03955337805600653 ; xx [ 4 ] = 0.5 ; xx
[ 5 ] = xx [ 4 ] * state [ 8 ] ; xx [ 6 ] = sin ( xx [ 5 ] ) ; xx [ 7 ] = cos
( xx [ 5 ] ) ; xx [ 8 ] = 0.07189840968753769 * xx [ 6 ] ; xx [ 9 ] =
0.9741263695734882 * xx [ 6 ] ; xx [ 10 ] = 0.2142625370567126 * xx [ 6 ] ;
pm_math_quatCompose ( xx + 0 , xx + 7 , xx + 11 ) ; xx [ 0 ] =
0.05182593581663095 ; xx [ 1 ] = - 0.1519742715228705 ; xx [ 2 ] = -
0.1034434723147636 ; xx [ 3 ] = 0.981589191671999 ; xx [ 5 ] = xx [ 4 ] *
state [ 10 ] ; xx [ 6 ] = sin ( xx [ 5 ] ) ; xx [ 7 ] = cos ( xx [ 5 ] ) ; xx
[ 8 ] = - ( 8.039551964383884e-5 * xx [ 6 ] ) ; xx [ 9 ] = - (
0.9999878887291287 * xx [ 6 ] ) ; xx [ 10 ] = - ( 4.920968565308881e-3 * xx [
6 ] ) ; pm_math_quatCompose ( xx + 0 , xx + 7 , xx + 15 ) ;
pm_math_quatCompose ( xx + 11 , xx + 15 , xx + 0 ) ; xx [ 5 ] = -
...
return ii [ 1 ] ; } int closedLoop_2f6391d8_1_isVelocityViolation ( const
...
ii [ 1 ] ; } PmfMessageId closedLoop_2f6391d8_1_projectStateSim ( const void
* mech , const RuntimeDerivedValuesBundle * rtdv , const int * eqnEnableFlags
, const double * input , double * state , void * neDiagMgr0 ) { const double
* rtdvd = rtdv -> mDoubles . mValues ; const int * rtdvi = rtdv -> mInts .
mValues ; NeuDiagnosticManager * neDiagMgr = ( NeuDiagnosticManager * )
neDiagMgr0 ; int ii [ 6 ] ; double xx [ 344 ] ; ( void ) mech ; ( void )
rtdvd ; ( void ) rtdvi ; ( void ) eqnEnableFlags ; ( void ) input ; ( void )
neDiagMgr ; xx [ 0 ] = 0.0 ; xx [ 1 ] = - 0.99302022896367 ; xx [ 2 ] =
0.1066412368322485 ; xx [ 3 ] = - 0.03120900126866927 ; xx [ 4 ] = -
0.03955337805600653 ; xx [ 5 ] = 0.5 ; xx [ 6 ] = xx [ 5 ] * state [ 8 ] ; xx
[ 7 ] = 0.07189840968753769 ; xx [ 8 ] = sin ( xx [ 6 ] ) ; xx [ 9 ] =
0.9741263695734882 ; xx [ 10 ] = 0.2142625370567126 ; xx [ 11 ] = cos ( xx [
6 ] ) ; xx [ 12 ] = xx [ 7 ] * xx [ 8 ] ; xx [ 13 ] = xx [ 9 ] * xx [ 8 ] ;
xx [ 14 ] = xx [ 10 ] * xx [ 8 ] ; pm_math_quatCompose ( xx + 1 , xx + 11 ,
xx + 15 ) ; xx [ 11 ] = 0.05182593581663095 ; xx [ 12 ] = -
0.1519742715228705 ; xx [ 13 ] = - 0.1034434723147636 ; xx [ 14 ] =
0.981589191671999 ; xx [ 6 ] = xx [ 5 ] * state [ 10 ] ; xx [ 8 ] =
8.039551964383884e-5 ; xx [ 19 ] = sin ( xx [ 6 ] ) ; xx [ 20 ] =
0.9999878887291287 ; xx [ 21 ] = 4.920968565308881e-3 ; xx [ 22 ] = cos ( xx
[ 6 ] ) ; xx [ 23 ] = - ( xx [ 8 ] * xx [ 19 ] ) ; xx [ 24 ] = - ( xx [ 20 ]
* xx [ 19 ] ) ; xx [ 25 ] = - ( xx [ 21 ] * xx [ 19 ] ) ; pm_math_quatCompose
( xx + 11 , xx + 22 , xx + 26 ) ; pm_math_quatCompose ( xx + 15 , xx + 26 ,
xx + 22 ) ; xx [ 30 ] = xx [ 7 ] ; xx [ 31 ] = xx [ 9 ] ; xx [ 32 ] = xx [ 10
] ; pm_math_quatInverseXform ( xx + 26 , xx + 30 , xx + 33 ) ; xx [ 36 ] = -
7.044490589730112e-3 ; xx [ 37 ] = - 6.108478301373796e-3 ; xx [ 38 ] = -
4.589550344615505e-3 ; pm_math_cross3 ( xx + 33 , xx + 36 , xx + 39 ) ;
pm_math_quatXform ( xx + 22 , xx + 39 , xx + 33 ) ; xx [ 6 ] =
0.01141939320659117 ; xx [ 39 ] = - 0.02929060823879809 ; xx [ 40 ] =
7.402384199146024e-3 ; xx [ 41 ] = 5.50599994432713e-4 ; pm_math_quatXform (
xx + 26 , xx + 39 , xx + 42 ) ; xx [ 19 ] = 7.654873829231559e-3 ; xx [ 45 ]
= 5.163891526827933e-4 ; xx [ 46 ] = xx [ 6 ] - xx [ 42 ] ; xx [ 47 ] = - (
xx [ 19 ] + xx [ 43 ] ) ; xx [ 48 ] = - ( xx [ 45 ] + xx [ 44 ] ) ;
pm_math_cross3 ( xx + 30 , xx + 46 , xx + 42 ) ; pm_math_quatXform ( xx + 15
, xx + 42 , xx + 49 ) ; xx [ 42 ] = - 3.67575678838696e-3 ; xx [ 43 ] =
1.562574744821344e-3 ; xx [ 44 ] = - 5.870667887890738e-3 ; pm_math_quatXform
( xx + 15 , xx + 42 , xx + 52 ) ; xx [ 55 ] = 4.559435129625171e-3 ; xx [ 56
] = 3.429673746578918e-5 ; xx [ 57 ] = - 7.043914177709157e-3 ;
pm_math_quatXform ( xx + 22 , xx + 55 , xx + 58 ) ; xx [ 61 ] =
5.14166426014702e-4 ; xx [ 62 ] = - 1.44182428174571e-4 ; xx [ 63 ] =
0.02929084861083201 ; pm_math_quatXform ( xx + 26 , xx + 61 , xx + 64 ) ;
...
"sm:compiler:messages:simulationErrors:ConstraintViolation" ,
 "'closedLoop/Plant/Robot/Gripper/Left Finger Revolute B' kinematic constraints cannot be maintained. Check solver type and consistency tolerance in the Simscape Solver Configuration block. Check Simulink solver type and tolerances in Model Configuration Parameters. A kinematic singularity might be the source of this problem."
, neDiagMgr ) ; } case 3 : case 4 : case 5 : { return
sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:ConstraintViolation" ,
 "'closedLoop/Plant/Robot/Gripper/Right Finger Revolute B' kinematic constraints cannot be maintained. Check solver type and consistency tolerance in the Simscape Solver Configuration block. Check Simulink solver type and tolerances in Model Configuration Parameters. A kinematic singularity might be the source of this problem."
