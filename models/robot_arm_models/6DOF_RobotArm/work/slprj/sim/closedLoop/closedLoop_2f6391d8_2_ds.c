...
#include "ne_ds.h"
#include "closedLoop_2f6391d8_2_ds_zc.h"
#include "closedLoop_2f6391d8_2_ds_tdxy_p.h"
#include "closedLoop_2f6391d8_2_ds_y.h"
#include "closedLoop_2f6391d8_2_ds_obs_all.h"
#include "closedLoop_2f6391d8_2_ds_obs_act.h"
#include "closedLoop_2f6391d8_2_ds_m_p.h"
#include "closedLoop_2f6391d8_2_ds_log.h"
#include "closedLoop_2f6391d8_2_ds_dxy_p.h"
#include "closedLoop_2f6391d8_2_ds_dnf_p.h"
#include "closedLoop_2f6391d8_2_ds_tdxf_p.h"
#include "closedLoop_2f6391d8_2_ds_a_p.h"
#include "closedLoop_2f6391d8_2_ds_obs_il.h"
#include "closedLoop_2f6391d8_2_ds_a.h"
#include "closedLoop_2f6391d8_2_ds_dxf_p.h"
#include "closedLoop_2f6391d8_2_ds_dxf.h"
#include "closedLoop_2f6391d8_2_ds_mode.h"
...
"closedLoop/Plant/Robot/Gripper/Mechanical Rotational Reference1" , 1U , 1U ,
...
"closedLoop/Plant/Robot/Gripper/Mechanical Rotational Reference2" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"Plant.Robot.Gripper.RFA_R.w" , "closedLoop/Plant/Robot/Gripper" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{ "Plant.Robot.Gripper.Torque_Actuated_Revolute_Joint_with_Position1.C.w" ,
"closedLoop/Plant/Robot/Gripper/Torque Actuated Revolute Joint with Position1"
...
,
 "closedLoop/Plant/Robot/Gripper/Torque Actuated Revolute Joint with Position1/Rot2Rev"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop/Plant/Robot/Gripper/Torque Actuated Revolute Joint with Position1/Rot2Rev/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop/Plant/Robot/Gripper/Torque Actuated Revolute Joint with Position3"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop/Plant/Robot/Gripper/Torque Actuated Revolute Joint with Position3/Rot2Rev"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop/Plant/Robot/Gripper/Torque Actuated Revolute Joint with Position3/Rot2Rev/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop/Plant/Robot" , 1U , 1U , "rad/s" , 1.0e-6 , "1/s" ,
NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"Plant.Robot.Mechanical_Rotational_Reference.W.w" ,
"closedLoop/Plant/Robot/Mechanical Rotational Reference" , 1U , 1U , "rad/s"
, 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"Plant.Robot.Mechanical_Rotational_Reference1.W.w" ,
"closedLoop/Plant/Robot/Mechanical Rotational Reference1" , 1U , 1U , "rad/s"
, 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"Plant.Robot.Mechanical_Rotational_Reference2.W.w" ,
"closedLoop/Plant/Robot/Mechanical Rotational Reference2" , 1U , 1U , "rad/s"
, 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"Plant.Robot.RFA_R.w" , "closedLoop/Plant/Robot" , 1U , 1U , "rad/s" , 1.0e-6
, "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"Plant.Robot.Torque_Actuated_Revolute_Joint_with_Position.C.w" ,
"closedLoop/Plant/Robot/Torque Actuated Revolute Joint with Position" , 1U ,
...
"closedLoop/Plant/Robot/Torque Actuated Revolute Joint with Position/Rot2Rev"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop/Plant/Robot/Torque Actuated Revolute Joint with Position/Rot2Rev/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop/Plant/Robot/Torque Actuated Revolute Joint with Position1" , 1U ,
1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" ,
...
"closedLoop/Plant/Robot/Torque Actuated Revolute Joint with Position1/Rot2Rev"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop/Plant/Robot/Torque Actuated Revolute Joint with Position1/Rot2Rev/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop/Plant/Robot/Torque Actuated Revolute Joint with Position2" , 1U ,
1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" ,
...
"closedLoop/Plant/Robot/Torque Actuated Revolute Joint with Position2/Rot2Rev"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop/Plant/Robot/Torque Actuated Revolute Joint with Position2/Rot2Rev/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop/Plant/Robot/Torque Actuated Revolute Joint with Position3" , 1U ,
1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" ,
...
"closedLoop/Plant/Robot/Torque Actuated Revolute Joint with Position3/Rot2Rev"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop/Plant/Robot/Torque Actuated Revolute Joint with Position3/Rot2Rev/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , { "Plant.Robot.UA_R.w" , "closedLoop/Plant/Robot"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , { "Plant.Robot.WA_R.w" , "closedLoop/Plant/Robot"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , { "Plant.Servomotors.C.w" ,
"closedLoop/Plant/Servomotors" , 1U , 1U , "rad/s" , 1.0e-6 , "1/s" ,
NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"Plant.Servomotors.FA_R.w" , "closedLoop/Plant/Servomotors" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{ "Plant.Servomotors.Fore_Arm_Servomotor.C.w" ,
"closedLoop/Plant/Servomotors/Fore Arm Servomotor" , 1U , 1U , "rad/s" ,
1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
...
"closedLoop/Plant/Servomotors/Fore Arm Servomotor/Uncontrolled Servomotor" ,
1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
"Plant.Servomotors.Fore_Arm_Servomotor.Uncontrolled_Servomotor.Gear_Box.O.w"
,
 "closedLoop/Plant/Servomotors/Fore Arm Servomotor/Uncontrolled Servomotor/Gear Box"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop/Plant/Servomotors/Fore Arm Servomotor/Uncontrolled Servomotor/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop/Plant/Servomotors/Fore Arm Servomotor" , 1U , 1U , "V" , 1.0e-6 ,
"V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
...
"V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Plant.Servomotors.GA_R.w" , "closedLoop/Plant/Servomotors" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{ "Plant.Servomotors.Gripper_Servomotor.C.w" ,
"closedLoop/Plant/Servomotors/Gripper Servomotor" , 1U , 1U , "rad/s" ,
1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
...
"closedLoop/Plant/Servomotors/Gripper Servomotor/Uncontrolled Servomotor" ,
1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
"Plant.Servomotors.Gripper_Servomotor.Uncontrolled_Servomotor.Gear_Box.O.w" ,
 "closedLoop/Plant/Servomotors/Gripper Servomotor/Uncontrolled Servomotor/Gear Box"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop/Plant/Servomotors/Gripper Servomotor/Uncontrolled Servomotor/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop/Plant/Servomotors/Gripper Servomotor" , 1U , 1U , "V" , 1.0e-6 ,
"V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
...
"V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Plant.Servomotors.LFA_R.w" , "closedLoop/Plant/Servomotors" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{ "Plant.Servomotors.Left_Finger_Servomotor.C.w" ,
"closedLoop/Plant/Servomotors/Left Finger Servomotor" , 1U , 1U , "rad/s" ,
1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
...
"closedLoop/Plant/Servomotors/Left Finger Servomotor/Uncontrolled Servomotor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
"Plant.Servomotors.Left_Finger_Servomotor.Uncontrolled_Servomotor.Gear_Box.O.w"
,
 "closedLoop/Plant/Servomotors/Left Finger Servomotor/Uncontrolled Servomotor/Gear Box"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop/Plant/Servomotors/Left Finger Servomotor/Uncontrolled Servomotor/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop/Plant/Servomotors/Left Finger Servomotor" , 1U , 1U , "V" ,
...
"closedLoop/Plant/Servomotors/Mechanical Rotational Reference" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"Plant.Servomotors.Mechanical_Rotational_Reference1.W.w" ,
"closedLoop/Plant/Servomotors/Mechanical Rotational Reference1" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"Plant.Servomotors.Mechanical_Rotational_Reference2.W.w" ,
"closedLoop/Plant/Servomotors/Mechanical Rotational Reference2" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"Plant.Servomotors.Mechanical_Rotational_Reference3.W.w" ,
"closedLoop/Plant/Servomotors/Mechanical Rotational Reference3" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"Plant.Servomotors.Mechanical_Rotational_Reference4.W.w" ,
"closedLoop/Plant/Servomotors/Mechanical Rotational Reference4" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"Plant.Servomotors.RFA_R.w" , "closedLoop/Plant/Servomotors" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{ "Plant.Servomotors.Right_Finger_Servomotor.C.w" ,
"closedLoop/Plant/Servomotors/Right Finger Servomotor" , 1U , 1U , "rad/s" ,
1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
...
"closedLoop/Plant/Servomotors/Right Finger Servomotor/Uncontrolled Servomotor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
"Plant.Servomotors.Right_Finger_Servomotor.Uncontrolled_Servomotor.Gear_Box.O.w"
,
 "closedLoop/Plant/Servomotors/Right Finger Servomotor/Uncontrolled Servomotor/Gear Box"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop/Plant/Servomotors/Right Finger Servomotor/Uncontrolled Servomotor/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop/Plant/Servomotors/Right Finger Servomotor" , 1U , 1U , "V" ,
1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
...
1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Plant.Servomotors.UA_R.w" , "closedLoop/Plant/Servomotors" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{ "Plant.Servomotors.Upper_Arm_Servomotor.C.w" ,
"closedLoop/Plant/Servomotors/Upper Arm Servomotor" , 1U , 1U , "rad/s" ,
1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
...
"closedLoop/Plant/Servomotors/Upper Arm Servomotor/Uncontrolled Servomotor" ,
1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
"Plant.Servomotors.Upper_Arm_Servomotor.Uncontrolled_Servomotor.Gear_Box.O.w"
,
 "closedLoop/Plant/Servomotors/Upper Arm Servomotor/Uncontrolled Servomotor/Gear Box"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop/Plant/Servomotors/Upper Arm Servomotor/Uncontrolled Servomotor/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop/Plant/Servomotors/Upper Arm Servomotor" , 1U , 1U , "V" , 1.0e-6
, "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
...
, "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Plant.Servomotors.WA_R.w" , "closedLoop/Plant/Servomotors" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{ "Plant.Servomotors.Wrist_Servomotor.C.w" ,
"closedLoop/Plant/Servomotors/Wrist Servomotor" , 1U , 1U , "rad/s" , 1.0e-6
, "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
...
"closedLoop/Plant/Servomotors/Wrist Servomotor/Uncontrolled Servomotor" , 1U
, 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE
, TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity"
, } , {
"Plant.Servomotors.Wrist_Servomotor.Uncontrolled_Servomotor.Gear_Box.O.w" ,
"closedLoop/Plant/Servomotors/Wrist Servomotor/Uncontrolled Servomotor/Gear Box"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
,
 "closedLoop/Plant/Servomotors/Wrist Servomotor/Uncontrolled Servomotor/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"closedLoop/Plant/Servomotors/Wrist Servomotor" , 1U , 1U , "V" , 1.0e-6 ,
"V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
...
"V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Plant.Servomotors.x0.v" , "closedLoop/Plant/Servomotors" , 1U , 1U , "V" ,
1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Plant.Servomotors.x1.v" , "closedLoop/Plant/Servomotors" , 1U , 1U , "V" ,
1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
...
-> mN ) ; } NeDynamicSystem * closedLoop_2f6391d8_2_dae_ds ( PmAllocator *
allocator ) { NeDynamicSystem * ds ; _NeDynamicSystem * _ds ; static
NeDsIoInfo input_info [ 12 ] ; static NeDsIoInfo output_info [ 18 ] ; _ds = (
...
closedLoop_2f6391d8_2_ds_m_p ; ds -> mMakeOutput [ NE_DS_METHOD_M_P ] =
...
mMethods [ NE_DS_METHOD_A_P ] = closedLoop_2f6391d8_2_ds_a_p ; ds ->
mMakeOutput [ NE_DS_METHOD_A_P ] = ds_output_a_p ; ds -> mMethods [
NE_DS_METHOD_A ] = closedLoop_2f6391d8_2_ds_a ; ds -> mMakeOutput [
...
NE_DS_METHOD_F ] = closedLoop_2f6391d8_2_ds_f ; ds -> mMakeOutput [
...
NE_DS_METHOD_DXF_P ] = closedLoop_2f6391d8_2_ds_dxf_p ; ds -> mMakeOutput [
NE_DS_METHOD_DXF_P ] = ds_output_dxf_p ; ds -> mMethods [ NE_DS_METHOD_DXF ]
= closedLoop_2f6391d8_2_ds_dxf ; ds -> mMakeOutput [ NE_DS_METHOD_DXF ] =
...
NE_DS_METHOD_TDXF_P ] = closedLoop_2f6391d8_2_ds_tdxf_p ; ds -> mMakeOutput [
NE_DS_METHOD_TDXF_P ] = ds_output_tdxf_p ; ds -> mMethods [
NE_DS_METHOD_DNF_P ] = closedLoop_2f6391d8_2_ds_dnf_p ; ds -> mMakeOutput [
NE_DS_METHOD_DNF_P ] = ds_output_dnf_p ; ds -> mMethods [ NE_DS_METHOD_DNF ]
= ds_dnf ; ds -> mMakeOutput [ NE_DS_METHOD_DNF ] = ds_output_dnf ; ds ->
mMethods [ NE_DS_METHOD_DNF_V_X ] = ds_dnf_v_x ; ds -> mMakeOutput [
...
closedLoop_2f6391d8_2_ds_tdxy_p ; ds -> mMakeOutput [ NE_DS_METHOD_TDXY_P ] =
ds_output_tdxy_p ; ds -> mMethods [ NE_DS_METHOD_Y ] =
closedLoop_2f6391d8_2_ds_y ; ds -> mMakeOutput [ NE_DS_METHOD_Y ] =
ds_output_y ; ds -> mMethods [ NE_DS_METHOD_DXY_P ] =
closedLoop_2f6391d8_2_ds_dxy_p ; ds -> mMakeOutput [ NE_DS_METHOD_DXY_P ] =
...
NE_DS_METHOD_MODE ] = closedLoop_2f6391d8_2_ds_mode ; ds -> mMakeOutput [
NE_DS_METHOD_MODE ] = ds_output_mode ; ds -> mMethods [ NE_DS_METHOD_ZC ] =
closedLoop_2f6391d8_2_ds_zc ; ds -> mMakeOutput [ NE_DS_METHOD_ZC ] =
...
NE_DS_METHOD_LOG ] = closedLoop_2f6391d8_2_ds_log ; ds -> mMakeOutput [
...
mMethods [ NE_DS_METHOD_OBS_ACT ] = closedLoop_2f6391d8_2_ds_obs_act ; ds ->
mMakeOutput [ NE_DS_METHOD_OBS_ACT ] = ds_output_obs_act ; ds -> mMethods [
NE_DS_METHOD_OBS_ALL ] = closedLoop_2f6391d8_2_ds_obs_all ; ds -> mMakeOutput
[ NE_DS_METHOD_OBS_ALL ] = ds_output_obs_all ; ds -> mMethods [
NE_DS_METHOD_OBS_IL ] = closedLoop_2f6391d8_2_ds_obs_il ; ds -> mMakeOutput [
