...
#endif
#include "nesl_rtw.h"
#include "closedLoop_toTune_b924f1e8_1.h"
void closedLoop_toTune_b924f1e8_1_gateway ( void ) { NeModelParameters
...
closedLoop_toTune_b924f1e8_1_dae ( & dae , & modelparams , & solverparams ) ;
nesl_register_simulator_group (
"closedLoop_toTune/Plant/Robot/Solver Configuration_1" , 1 , & dae , &
