...
PmfMessageId closedLoop_toTune_b924f1e8_1_deriv ( const
...
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop_toTune/Plant/Robot/Gripper/Left Finger Revolute  A' has a degenerate mass distribution on its follower side."
...
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop_toTune/Plant/Robot/Gripper/Left Revolute A' has a degenerate mass distribution on its follower side."
...
return sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop_toTune/Plant/Robot/Gripper/Torque Actuated Revolute Joint with Position1/Upper Arm Revolute' has a degenerate mass distribution on its follower side."
...
return sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop_toTune/Plant/Robot/Gripper/Torque Actuated Revolute Joint with Position3/Upper Arm Revolute' has a degenerate mass distribution on its follower side."
...
0 ) { return sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop_toTune/Plant/Robot/Gripper/Right Finger Revolute A' has a degenerate mass distribution on its follower side."
...
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop_toTune/Plant/Robot/Gripper/Right Revolute A' has a degenerate mass distribution on its follower side."
...
!= 0 ) { return sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop_toTune/Plant/Robot/Torque Actuated Revolute Joint with Position3/Upper Arm Revolute' has a degenerate mass distribution on its follower side."
...
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop_toTune/Plant/Robot/Torque Actuated Revolute Joint with Position2/Upper Arm Revolute' has a degenerate mass distribution on its follower side."
...
!= 0 ) { return sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop_toTune/Plant/Robot/Torque Actuated Revolute Joint with Position1/Upper Arm Revolute' has a degenerate mass distribution on its follower side."
...
return sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'closedLoop_toTune/Plant/Robot/Torque Actuated Revolute Joint with Position/Upper Arm Revolute' has a degenerate mass distribution on its follower side."
