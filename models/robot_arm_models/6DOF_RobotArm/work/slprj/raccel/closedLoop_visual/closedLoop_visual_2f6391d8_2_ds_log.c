...
int32_T closedLoop_visual_2f6391d8_2_ds_log ( const NeDynamicSystem * sys ,
const NeDynamicSystemInput * t7 , NeDsMethodOutput * t8 ) { PmRealVector out
; real_T Plant_Robot_FA_R_w ; real_T Plant_Robot_Gripper_LFA_R_w ; real_T
...
29 ] ; out = t8 -> mLOG ; Plant_Robot_FA_R_w = X_idx_0 * 0.1 ;
...
= 0.0 ; t0 [ 302ULL ] = 12.0 ; t0 [ 303ULL ] = 0.0 ; for ( b = 0 ; b < 304 ;
b ++ ) { out . mX [ b ] = t0 [ b ] ; } ( void ) sys ; ( void ) t8 ; return 0
; }
