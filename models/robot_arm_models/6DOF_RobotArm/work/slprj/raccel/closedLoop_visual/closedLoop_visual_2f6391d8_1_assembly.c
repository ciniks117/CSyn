...
boolean_T closedLoop_visual_2f6391d8_1_getTargetStatus ( const
RuntimeDerivedValuesBundle * rtdv , const double * state , const size_t
targetIndex ) { return true ; } void closedLoop_visual_2f6391d8_1_setTargets
( const RuntimeDerivedValuesBundle * rtdv , CTarget * targets ) { ( void )
rtdv ; ( void ) targets ; } void
closedLoop_visual_2f6391d8_1_resetStateVector ( const void * mech , double *
...
void closedLoop_visual_2f6391d8_1_computeDiscreteState ( const void * mech ,
...
} void closedLoop_visual_2f6391d8_1_adjustPosition ( const void * mech ,
...
void closedLoop_visual_2f6391d8_1_perturbJointPrimitiveState ( const void *
...
closedLoop_visual_2f6391d8_1_computeDofBlendMatrix ( const void * mech ,
...
} size_t closedLoop_visual_2f6391d8_1_computeAssemblyError ( const void *
...
closedLoop_visual_2f6391d8_1_constructStateVector ( const void * mech , const
...
closedLoop_visual_2f6391d8_1_extractSolverStateVector ( const void * mech ,
...
] = fullState [ 23 ] ; } int closedLoop_visual_2f6391d8_1_isPositionViolation
...
return ii [ 1 ] ; } int closedLoop_visual_2f6391d8_1_isVelocityViolation (
const void * mech , const RuntimeDerivedValuesBundle * rtdv , const int *
eqnEnableFlags , const double * state ) { const double * rtdvd = rtdv ->
mDoubles . mValues ; const int * rtdvi = rtdv -> mInts . mValues ; int ii [ 3
...
ii [ 1 ] ; } PmfMessageId closedLoop_visual_2f6391d8_1_projectStateSim (
const void * mech , const RuntimeDerivedValuesBundle * rtdv , const int *
