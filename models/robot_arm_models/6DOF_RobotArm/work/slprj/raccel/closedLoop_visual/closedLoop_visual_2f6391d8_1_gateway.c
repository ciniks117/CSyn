...
#endif
#include "nesl_rtw.h"
#include "closedLoop_visual_2f6391d8_1.h"
void closedLoop_visual_2f6391d8_1_gateway ( void ) { NeModelParameters
...
closedLoop_visual_2f6391d8_1_dae ( & dae , & modelparams , & solverparams ) ;
nesl_register_simulator_group (
"closedLoop_visual/Plant/Robot/Solver Configuration_1" , 1 , & dae , &
