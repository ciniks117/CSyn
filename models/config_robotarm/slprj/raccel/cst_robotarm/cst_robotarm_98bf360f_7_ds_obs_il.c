...
int32_T cst_robotarm_98bf360f_7_ds_obs_il ( const NeDynamicSystem * sys ,
const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmBoolVector out
; boolean_T t0 [ 146 ] ; int32_T b ; static boolean_T _cg_const_1 [ 146 ] = {
...
true , false } ; ( void ) t1 ; out = t2 -> mOBS_IL ; for ( b = 0 ; b < 146 ;
b ++ ) { t0 [ b ] = _cg_const_1 [ b ] ; } for ( b = 0 ; b < 146 ; b ++ ) {
