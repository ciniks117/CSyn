...
#include "nesl_la.h"
#include "cst_robotarm_98bf360f_7.h"
#include "cst_robotarm_98bf360f_7_ds.h"
void cst_robotarm_98bf360f_7_dae ( NeDae * * dae , const NeModelParameters *
...
cst_robotarm_98bf360f_7_dae_ds ( ne_allocator ) , NULL , FALSE , *
