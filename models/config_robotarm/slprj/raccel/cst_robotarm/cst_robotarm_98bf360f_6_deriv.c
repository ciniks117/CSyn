...
#include "cst_robotarm_98bf360f_6_geometries.h"
...
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'cst_robotarm/6 DOF Robot Arm/6 DOF Robot Arm Mechanics/Gripper/Revolute' has a degenerate mass distribution on its follower side."
...
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'cst_robotarm/6 DOF Robot Arm/6 DOF Robot Arm Mechanics/Gripper/Revolute2' has a degenerate mass distribution on its follower side."
...
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'cst_robotarm/6 DOF Robot Arm/6 DOF Robot Arm Mechanics/Gripper/Revolute3' has a degenerate mass distribution on its follower side."
...
return sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'cst_robotarm/6 DOF Robot Arm/6 DOF Robot Arm Mechanics/Gripper/Revolute1' has a degenerate mass distribution on its follower side."
...
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'cst_robotarm/6 DOF Robot Arm/6 DOF Robot Arm Mechanics/R7' has a degenerate mass distribution on its follower side."
...
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'cst_robotarm/6 DOF Robot Arm/6 DOF Robot Arm Mechanics/R6' has a degenerate mass distribution on its follower side."
...
return sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'cst_robotarm/6 DOF Robot Arm/6 DOF Robot Arm Mechanics/R5' has a degenerate mass distribution on its follower side."
...
return sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'cst_robotarm/6 DOF Robot Arm/6 DOF Robot Arm Mechanics/R4' has a degenerate mass distribution on its follower side."
...
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'cst_robotarm/6 DOF Robot Arm/6 DOF Robot Arm Mechanics/R3' has a degenerate mass distribution on its follower side."
...
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'cst_robotarm/6 DOF Robot Arm/6 DOF Robot Arm Mechanics/R2' has a degenerate mass distribution on its follower side."
...
if ( ii [ 0 ] != 0 ) { return sm_ssci_recordRunTimeError (
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'cst_robotarm/6 DOF Robot Arm/6 DOF Robot Arm Mechanics/R1' has a degenerate mass distribution on its follower side."
