...
#endif
#include "nesl_rtw.h"
#include "cst_robotarm_original_6f156994_2.h"
#include "cst_robotarm_original_6f156994_2_gateway.h"
void cst_robotarm_original_6f156994_2_gateway ( void ) { NeModelParameters
modelparams = { ( NeSolverType ) 0 , 0.001 , 1 , 0 , 0.001 , 0 , 0 , 0 , 0 ,
( SscLoggingSetting ) 0 , 518872249 , } ; NeSolverParameters solverparams = {
...
cst_robotarm_original_6f156994_2_dae ( & dae , & modelparams , & solverparams
