...
int32_T cst_robotarm_original_6f156994_7_ds_log ( const NeDynamicSystem * sys
, const NeDynamicSystemInput * t5 , NeDsMethodOutput * t6 ) { PmRealVector
out ; real_T x6_DOF_Robot_Arm_DC_Motors_Bicep_Interface_Ideal_Angular_Veloc1
; real_T x6_DOF_Robot_Arm_DC_Motors_Bicep_Motor1_DC_Motor_i ; real_T
