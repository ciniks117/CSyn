...
int32_T cst_robotarm_original_6f156994_3_ds_log ( const NeDynamicSystem * sys
, const NeDynamicSystemInput * t3 , NeDsMethodOutput * t4 ) { PmRealVector
out ; real_T x6_DOF_Robot_Arm_DC_Motors_Hand_Interface_Ideal_Angular_Veloci1
; real_T x6_DOF_Robot_Arm_DC_Motors_Hand_Motor_DC_Motor_i ; real_T t1 ;
