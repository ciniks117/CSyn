...
void cst_robotarm_original_6f156994_6_resetSimStateVector ( const void * mech
, double * state ) { double xx [ 1 ] ; ( void ) mech ; xx [ 0 ] = 0.0 ; state
[ 0 ] = xx [ 0 ] ; state [ 1 ] = xx [ 0 ] ; state [ 2 ] = xx [ 0 ] ; state [
3 ] = xx [ 0 ] ; state [ 4 ] = xx [ 0 ] ; state [ 5 ] = xx [ 0 ] ; state [ 6
...
void cst_robotarm_original_6f156994_6_perturbSimJointPrimitiveState ( const
...
cst_robotarm_original_6f156994_6_constructStateVector ( const void * mech ,
...
return ii [ 1 ] ; } int cst_robotarm_original_6f156994_6_isVelocityViolation
...
, xx + 38 ) ) - state [ 26 ] ) - state [ 28 ] + atan2 (
pm_math_Vector3_dot_ra ( xx + 6 , xx + 23 ) , pm_math_Vector3_dot_ra ( xx + 6
, xx + 34 ) ) ) ; } void cst_robotarm_original_6f156994_6_resetModeVector (
const void * mech , int * modeVector ) { ( void ) mech ; ( void ) modeVector
; } boolean_T cst_robotarm_original_6f156994_6_hasJointDisToNormModeChange (
const void * mech , const int * prevModeVector , const int * modeVector ) { (
void ) mech ; ( void ) prevModeVector ; ( void ) modeVector ; return 0 ; }
PmfMessageId cst_robotarm_original_6f156994_6_performJointDisToNormModeChange
( const void * mech , const RuntimeDerivedValuesBundle * rtdv , const int *
...
PmfMessageId cst_robotarm_original_6f156994_6_onModeChangedCutJoints ( const
