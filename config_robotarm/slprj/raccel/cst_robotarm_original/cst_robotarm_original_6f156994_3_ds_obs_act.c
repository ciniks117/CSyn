...
int32_T cst_robotarm_original_6f156994_3_ds_obs_act ( const NeDynamicSystem *
sys , const NeDynamicSystemInput * t3 , NeDsMethodOutput * t4 ) {
PmRealVector out ; real_T
x6_DOF_Robot_Arm_DC_Motors_Hand_Interface_Ideal_Angular_Veloci1 ; real_T
x6_DOF_Robot_Arm_DC_Motors_Hand_Motor_DC_Motor_i ; real_T t1 ; real_T U_idx_0
; real_T U_idx_1 ; real_T U_idx_2 ; real_T U_idx_3 ; real_T X_idx_0 ; real_T
X_idx_3 ; real_T X_idx_2 ; real_T X_idx_1 ; U_idx_0 = t3 -> mU . mX [ 0 ] ;
U_idx_1 = t3 -> mU . mX [ 1 ] ; U_idx_2 = t3 -> mU . mX [ 2 ] ; U_idx_3 = t3
-> mU . mX [ 3 ] ; X_idx_0 = t3 -> mX . mX [ 0 ] ; X_idx_1 = t3 -> mX . mX [
1 ] ; X_idx_2 = t3 -> mX . mX [ 2 ] ; X_idx_3 = t3 -> mX . mX [ 3 ] ; out =
t4 -> mOBS_ACT ;
x6_DOF_Robot_Arm_DC_Motors_Hand_Interface_Ideal_Angular_Veloci1 = ( X_idx_0 *
0.47777133790671145 + X_idx_3 * 4.7777133790671148E-10 ) + U_idx_3 * -
0.92143414237940879 ; x6_DOF_Robot_Arm_DC_Motors_Hand_Motor_DC_Motor_i = (
...
. mX [ 4 ] = x6_DOF_Robot_Arm_DC_Motors_Hand_Interface_Ideal_Angular_Veloci1
; out . mX [ 5 ] = U_idx_3 ; out . mX [ 6 ] = U_idx_3 ; out . mX [ 7 ] =
U_idx_3 ; out . mX [ 8 ] =
x6_DOF_Robot_Arm_DC_Motors_Hand_Interface_Ideal_Angular_Veloci1 ; out . mX [
9 ] = x6_DOF_Robot_Arm_DC_Motors_Hand_Interface_Ideal_Angular_Veloci1 ; out .
mX [ 10 ] = 0.0 ; out . mX [ 11 ] = U_idx_3 ; out . mX [ 12 ] = 0.0 ; out .
mX [ 13 ] = U_idx_3 ; out . mX [ 14 ] = 0.0 ; out . mX [ 15 ] = 0.0 ; out .
mX [ 16 ] = 0.0 ; out . mX [ 17 ] =
x6_DOF_Robot_Arm_DC_Motors_Hand_Motor_DC_Motor_i ; out . mX [ 18 ] = X_idx_0
; out . mX [ 19 ] = 0.0 ; out . mX [ 20 ] = X_idx_3 ; out . mX [ 21 ] = - (
x6_DOF_Robot_Arm_DC_Motors_Hand_Motor_DC_Motor_i *
x6_DOF_Robot_Arm_DC_Motors_Hand_Motor_DC_Motor_i * 0.0049993815260278305 ) /
...
44 ] = - x6_DOF_Robot_Arm_DC_Motors_Hand_Motor_DC_Motor_i ; out . mX [ 45 ] =
0.0 ; out . mX [ 46 ] = 0.0 ; out . mX [ 47 ] = 0.0 ; out . mX [ 48 ] = 0.0 ;
out . mX [ 49 ] = 0.0 ; out . mX [ 50 ] = 0.0 ; out . mX [ 51 ] = X_idx_3 ;
out . mX [ 52 ] = - ( x6_DOF_Robot_Arm_DC_Motors_Hand_Motor_DC_Motor_i *
x6_DOF_Robot_Arm_DC_Motors_Hand_Motor_DC_Motor_i * 0.0001 ) / - 1.0 * 1000.0
