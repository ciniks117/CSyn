...
void cst_robotarm_original_6f156994_6_setTargets ( const
RuntimeDerivedValuesBundle * rtdv , CTarget * targets ) { ( void ) rtdv ; (
void ) targets ; } void cst_robotarm_original_6f156994_6_resetAsmStateVector
...
0 ] ; state [ 27 ] = xx [ 0 ] ; state [ 28 ] = xx [ 0 ] ; } static
PmfMessageId initializeTrackedAngleState_0 ( const RuntimeDerivedValuesBundle
...
[ 18 ] ; ( void ) rtdvd ; ( void ) rtdvi ; ( void ) modeVector ; ( void )
neDiagMgr ; xx [ 0 ] = 0.3903970898504619 ; xx [ 1 ] = 0.4638409844798791 ;
xx [ 2 ] = 0.6471879634523136 ; xx [ 3 ] = 0.4621573252859613 ; xx [ 4 ] = -
motionData [ 84 ] ; xx [ 5 ] = - motionData [ 85 ] ; xx [ 6 ] = - motionData
[ 86 ] ; xx [ 7 ] = - motionData [ 87 ] ;
pm_math_Quaternion_inverseCompose_ra ( xx + 0 , xx + 4 , xx + 8 ) ; xx [ 0 ]
= 0.9606008463440403 ; xx [ 1 ] = 0.2033682862169496 ; xx [ 2 ] = -
0.1894395791916108 ; xx [ 12 ] = motionData [ 149 ] ; xx [ 13 ] = motionData
[ 150 ] ; xx [ 14 ] = motionData [ 151 ] ; pm_math_Quaternion_inverseXform_ra
( xx + 4 , xx + 12 , xx + 15 ) ; xx [ 3 ] = motionData [ 179 ] - xx [ 15 ] ;
xx [ 4 ] = motionData [ 180 ] - xx [ 16 ] ; xx [ 5 ] = motionData [ 181 ] -
xx [ 17 ] ; state [ 22 ] = sm_core_canonicalAngle ( 2.0 * ( (
pm_math_Vector3_dot_ra ( xx + 9 , xx + 0 ) * xx [ 8 ] ) < 0.0 ? - 1.0 : + 1.0
) * atan2 ( sqrt ( xx [ 9 ] * xx [ 9 ] + xx [ 10 ] * xx [ 10 ] + xx [ 11 ] *
xx [ 11 ] ) , fabs ( xx [ 8 ] ) ) ) ; state [ 23 ] = pm_math_Vector3_dot_ra (
xx + 3 , xx + 0 ) ; return NULL ; } static PmfMessageId
...
xx [ 0 ] = 0.245648950422414 ; xx [ 1 ] = 0.371074456249555 ; xx [ 2 ] =
0.7205531756845295 ; xx [ 3 ] = 0.5317550771609079 ; xx [ 4 ] = - motionData
[ 105 ] ; xx [ 5 ] = - motionData [ 106 ] ; xx [ 6 ] = - motionData [ 107 ] ;
xx [ 7 ] = - motionData [ 108 ] ; pm_math_Quaternion_inverseCompose_ra ( xx +
0 , xx + 4 , xx + 8 ) ; xx [ 0 ] = 0.9606008463440439 ; xx [ 1 ] =
0.2033682862169333 ; xx [ 2 ] = 0.1894395791916105 ; xx [ 12 ] = motionData [
...
cst_robotarm_original_6f156994_6_computeDiscreteState ( const void * mech ,
const RuntimeDerivedValuesBundle * rtdv , double * state ) { const double *
rtdvd = rtdv -> mDoubles . mValues ; const int * rtdvi = rtdv -> mInts .
mValues ; double xx [ 27 ] ; ( void ) mech ; ( void ) rtdvd ; ( void ) rtdvi
; xx [ 0 ] = - 0.215751709792892 ; xx [ 1 ] = - 0.2981849626920737 ; xx [ 2 ]
= - 2.033832353854736e-3 ; xx [ 3 ] = - 0.929802554993116 ; xx [ 4 ] = 0.5 ;
xx [ 5 ] = xx [ 4 ] * state [ 10 ] ; xx [ 6 ] = sin ( xx [ 5 ] ) ; xx [ 7 ] =
cos ( xx [ 5 ] ) ; xx [ 8 ] = - ( 0.3826804379272233 * xx [ 6 ] ) ; xx [ 9 ]
...
] = state [ 20 ] + dofDeltas [ 10 ] ; } static void
...
void cst_robotarm_original_6f156994_6_perturbAsmJointPrimitiveState ( const
...
* rtdvi = rtdv -> mInts . mValues ; double xx [ 199 ] ; ( void ) mech ; (
void ) rtdvd ; ( void ) rtdvi ; xx [ 0 ] = - 0.1692414246820599 ; xx [ 1 ] =
- 0.3581204221974448 ; xx [ 2 ] = - 0.8093344294744581 ; xx [ 3 ] = -
0.4336875426432772 ; xx [ 4 ] = 0.5 ; xx [ 5 ] = xx [ 4 ] * state [ 0 ] ; xx
[ 6 ] = 0.726474170332262 ; xx [ 7 ] = sin ( xx [ 5 ] ) ; xx [ 8 ] =
0.3673297571223195 ; xx [ 9 ] = 0.5807788988698797 ; xx [ 10 ] = cos ( xx [ 5
] ) ; xx [ 11 ] = xx [ 6 ] * xx [ 7 ] ; xx [ 12 ] = xx [ 8 ] * xx [ 7 ] ; xx
[ 13 ] = xx [ 9 ] * xx [ 7 ] ; pm_math_Quaternion_compose_ra ( xx + 0 , xx +
10 , xx + 14 ) ; xx [ 0 ] = - 0.05048244279655015 ; xx [ 1 ] = -
0.01046499991598876 ; xx [ 2 ] = - 0.04830501008340782 ;
pm_math_Quaternion_xform_ra ( xx + 14 , xx + 0 , xx + 10 ) ; xx [ 0 ] =
0.7159504556807283 ; xx [ 1 ] = 0.07585744831336452 ; xx [ 2 ] =
0.4515044164477732 ; xx [ 3 ] = 0.527071488959609 ; xx [ 5 ] = xx [ 4 ] *
state [ 2 ] ; xx [ 7 ] = sin ( xx [ 5 ] ) ; xx [ 13 ] = 3.070998455534379e-9
; xx [ 18 ] = 1.310006828569854e-7 ; xx [ 19 ] = cos ( xx [ 5 ] ) ; xx [ 20 ]
= xx [ 7 ] ; xx [ 21 ] = xx [ 13 ] * xx [ 7 ] ; xx [ 22 ] = xx [ 18 ] * xx [
7 ] ; pm_math_Quaternion_compose_ra ( xx + 0 , xx + 19 , xx + 23 ) ; xx [ 0 ]
= 0.02468880031958475 ; xx [ 1 ] = - 0.0762253912505382 ; xx [ 2 ] =
3.895808054025665e-9 ; pm_math_Quaternion_xform_ra ( xx + 23 , xx + 0 , xx +
19 ) ; xx [ 0 ] = 9.610261677013888e-3 - xx [ 19 ] ; xx [ 1 ] =
0.03773161350321224 - xx [ 20 ] ; xx [ 2 ] = - ( 0.01036879698058195 + xx [
21 ] ) ; xx [ 19 ] = - 0.5306023599600851 ; xx [ 20 ] = 0.466893522841787 ;
xx [ 21 ] = - 0.4674001539794631 ; xx [ 22 ] = 0.5310448851021436 ; xx [ 3 ]
= xx [ 4 ] * state [ 4 ] ; xx [ 5 ] = 9.431509536441641e-4 ; xx [ 7 ] = sin (
xx [ 3 ] ) ; xx [ 27 ] = 0.1270949996850012 ; xx [ 28 ] = 0.9918901005259344
; xx [ 29 ] = cos ( xx [ 3 ] ) ; xx [ 30 ] = - ( xx [ 5 ] * xx [ 7 ] ) ; xx [
31 ] = xx [ 27 ] * xx [ 7 ] ; xx [ 32 ] = xx [ 28 ] * xx [ 7 ] ;
...
return 5 ; } size_t cst_robotarm_original_6f156994_6_computeAssemblyJacobian
...
const int * modeVector , const double * motionData , double * J ) { ( void )
mech ; ( void ) rtdv ; ( void ) state ; ( void ) modeVector ; ( void )
...
cst_robotarm_original_6f156994_6_computeFullAssemblyJacobian ( const void *
...
rtdvd = rtdv -> mDoubles . mValues ; const int * rtdvi = rtdv -> mInts .
mValues ; double xx [ 108 ] ; ( void ) mech ; ( void ) rtdvd ; ( void ) rtdvi
; ( void ) modeVector ; xx [ 0 ] = 0.0 ; xx [ 1 ] = 0.6950555487140754 ; xx [
2 ] = - 0.4332134671585962 ; xx [ 3 ] = - 0.4754690018336444 ; xx [ 4 ] = -
...
cst_robotarm_original_6f156994_6_convertStateVector ( const void * asmMech ,
...
simState [ 28 ] = asmState [ 28 ] ; return NULL ; }
