#include "ne_ds.h"
#include "cst_robotarm_original_6f156994_1_ds_zc.h"
#include "cst_robotarm_original_6f156994_1_ds_obs_il.h"
#include "cst_robotarm_original_6f156994_1_ds_obs_all.h"
#include "cst_robotarm_original_6f156994_1_ds_obs_act.h"
#include "cst_robotarm_original_6f156994_1_ds_obs_exp.h"
#include "cst_robotarm_original_6f156994_1_ds_log.h"
#include "cst_robotarm_original_6f156994_1_ds_dxf.h"
#include "cst_robotarm_original_6f156994_1_ds_f.h"
#include "cst_robotarm_original_6f156994_1_ds.h"
#include "ssc_ml_fun.h"
#include "cst_robotarm_original_6f156994_1_ds_external_struct.h"
#include "cst_robotarm_original_6f156994_1_ds_sys_struct.h"
#include "cst_robotarm_original_6f156994_1_ds_externals.h"
...
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 2U ,
...
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor.i_L" , 0U , 0 ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1.0
, "1" , 0.0 , TRUE , FALSE , 1U , 1U , NE_INIT_MODE_MANDATORY , "Current" , }
, { "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.v_lag" ,
0U , 0 ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1.0 , "1" , 0.0 , TRUE , FALSE , 1U , 1U , NE_INIT_MODE_MANDATORY ,
"Lag variable" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.p2.v"
, 0U , 1 ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1.0 , "1" , 0.0 , FALSE , FALSE , 1U , 1U , NE_INIT_MODE_NONE , "Voltage" ,
} , { "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor.v" , 0U , 0 ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1.0
...
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Interface.C.w" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Interface" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Interface.Ideal_Angular_Velocity_Source.C.w"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Interface/Ideal Angular Velocity Source"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Interface.Ideal_Angular_Velocity_Source.R.w"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Interface/Ideal Angular Velocity Source"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Interface.Ideal_Angular_Velocity_Source.S"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Interface/Ideal Angular Velocity Source"
, 1U , 1U , "rad/s" , 1.0e-6 , "rad/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "S"
, } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Interface.Ideal_Angular_Velocity_Source.t"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Interface/Ideal Angular Velocity Source"
, 1U , 1U , "N*m" , 1.0e-6 , "J" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE
, FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Torque" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Interface.Ideal_Angular_Velocity_Source.w"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Interface/Ideal Angular Velocity Source"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Angular velocity" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Interface.Ideal_Torque_Sensor.C.w" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Interface/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Interface.Ideal_Torque_Sensor.R.w" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Interface/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Interface.Ideal_Torque_Sensor.T" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Interface/Ideal Torque Sensor"
, 1U , 1U , "N*m" , 1.0e-6 , "J" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE
...
, 1U , 1U , "N*m" , 1.0e-6 , "J" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE
, FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Torque" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Interface.Ideal_Torque_Sensor.w" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Interface/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Angular velocity" , } , { "x6_DOF_Robot_Arm.DC_Motors.Wrist_Interface.R.w" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Interface" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{ "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor.C.w" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U ,
...
} , { "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor.R.w" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U ,
1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" ,
} , { "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor.fn.v" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U ,
1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor.fp.v" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U ,
1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor.ground_not_used.V.v" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U ,
1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor.i" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U ,
1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Armature current" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor.i_L" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U ,
1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_MANDATORY ,
FALSE , TRUE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor.n.v" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U ,
1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor.p.v" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U ,
1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor.power_dissipated" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U ,
1U , "W" , 1.0e-6 , "kW" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Power dissipated" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor.t" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U ,
1U , "N*m" , 1.0e-6 , "J" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Torque" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor.v" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U ,
1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor.v_f" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U ,
1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Field voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor.w" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U ,
1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Angular velocity" , }
, { "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Electrical_Reference2.V.v" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Electrical Reference2"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Housing.w" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Mechanical_Rotational_Reference.W.w"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Mechanical Rotational Reference"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.i1"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Input current" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.n1.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.n2.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.p1.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
...
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.pwm.duty_cycle"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "1" , 1.0e-6 , "1" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Duty cycle" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.pwm.i2"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Output current" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.pwm.n2.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.pwm.p2.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.pwm.v2"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Output voltage" , } ,
{
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.Electrical_Reference1.V.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/Electrical Reference1"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.BRK.v" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.ENA.v" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.REF.v" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.REV.v" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.i2" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current (+ -> -)" , }
, { "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.iBRK" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current (BRK -> REF)" ,
} , { "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.iENA"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current (ENA -> REF)" ,
} , { "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.iREV"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current (REV -> REF)" ,
} , { "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.n1.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.n2.v" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.p1.v" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.p2.v" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.power_dissipated"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "W" , 1.0e-6 , "kW" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE
, FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Power dissipated" ,
} , { "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.v2" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Output voltage" , } ,
{ "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.v_lag" ,
...
"Lag variable" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vbrk.Electrical_Reference1.V.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk/Electrical Reference1"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vbrk.Voltage_Source.i"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "i" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vbrk.Voltage_Source.n.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vbrk.Voltage_Source.p.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vbrk.Voltage_Source.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "v" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vbrk.Voltage_Source.vT"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "vT" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vbrk.Volts.v" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vduty.Electrical_Reference1.V.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty/Electrical Reference1"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vduty.Voltage_Source.i"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "i" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vduty.Voltage_Source.n.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vduty.Voltage_Source.p.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vduty.Voltage_Source.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "v" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vduty.Voltage_Source.vT"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "vT" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vduty.Volts.v" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Electrical_Reference1.V.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev/Electrical Reference1"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.i"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "i" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.n.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.p.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.v"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "v" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.vT"
,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "vT" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Volts.v" ,
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.V0.v" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.V1.v" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Shaft.w" ,
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } }
...
5 ] = { {
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 0U , "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge"
,
 "/usr/local/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, NE_ZC_TYPE_FALSE , } , {
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge"
,
 "/usr/local/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, NE_ZC_TYPE_TRUE , } , {
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 2U , "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge"
,
 "/usr/local/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, NE_ZC_TYPE_FALSE , } , {
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 3U , "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge"
,
 "/usr/local/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, NE_ZC_TYPE_FALSE , } , {
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 4U , "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge"
,
 "/usr/local/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
...
s_assert_data [ 7 ] = { {
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 0U ,
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage"
,
...
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U ,
1U , "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor" ,
...
"cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U ,
2U , "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor" ,
 "/usr/local/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+electromech/+brushed/dc_motor.sscp"
, TRUE ,
...
, "physmod:common:mf:core:asserts:RequireBaseNonnegative" , } , {
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 5U , "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge"
,
 "/usr/local/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, FALSE , "In divide, the denominator must be nonzero." ,
"physmod:common:mf:core:asserts:RequireDenominatorNonzero" , } , {
 "cst_robotarm_original/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 6U , "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge"
,
 "/usr/local/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, FALSE , "In divide, the denominator must be nonzero." ,
...
-> mN ) ; } NeDynamicSystem * cst_robotarm_original_6f156994_1_dae_ds (
PmAllocator * allocator ) { NeDynamicSystem * ds ; _NeDynamicSystem * _ds ;
static NeDsIoInfo input_info [ 4 ] ; static NeDsIoInfo output_info [ 1 ] ;
...
mName = "x6_DOF_Robot_Arm.DC_Motors.Wrist_Interface.Ideal_Torque_Sensor.T" ;
...
cst_robotarm_original_6f156994_1_ds_f ; ds -> mMakeOutput [ NE_DS_METHOD_F ]
...
NE_DS_METHOD_DXF ] = cst_robotarm_original_6f156994_1_ds_dxf ; ds ->
...
cst_robotarm_original_6f156994_1_ds_zc ; ds -> mMakeOutput [ NE_DS_METHOD_ZC
...
NE_DS_METHOD_LOG ] = cst_robotarm_original_6f156994_1_ds_log ; ds ->
...
cst_robotarm_original_6f156994_1_ds_obs_exp ; ds -> mMakeOutput [
NE_DS_METHOD_OBS_EXP ] = ds_output_obs_exp ; ds -> mMethods [
NE_DS_METHOD_OBS_ACT ] = cst_robotarm_original_6f156994_1_ds_obs_act ; ds ->
mMakeOutput [ NE_DS_METHOD_OBS_ACT ] = ds_output_obs_act ; ds -> mMethods [
NE_DS_METHOD_OBS_ALL ] = cst_robotarm_original_6f156994_1_ds_obs_all ; ds ->
mMakeOutput [ NE_DS_METHOD_OBS_ALL ] = ds_output_obs_all ; ds -> mMethods [
NE_DS_METHOD_OBS_IL ] = cst_robotarm_original_6f156994_1_ds_obs_il ; ds ->
