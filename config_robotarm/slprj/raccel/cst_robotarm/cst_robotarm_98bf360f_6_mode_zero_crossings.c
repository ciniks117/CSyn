...
const NeZCData * cst_robotarm_98bf360f_6_ZCData = NULL ; PmfMessageId
cst_robotarm_98bf360f_6_computeAsmModeVector ( const double * input , const
...
cst_robotarm_98bf360f_6_computeSimModeVector ( const double * input , const
double * inputDot , const double * inputDdot , int * modeVector , double *
errorResult , NeuDiagnosticManager * neDiagMgr ) { ( void ) input ; ( void )
inputDot ; ( void ) inputDdot ; ( void ) modeVector ; ( void ) neDiagMgr ;
errorResult [ 0 ] = 0.0 ; return NULL ; } PmfMessageId
cst_robotarm_98bf360f_6_computeZeroCrossings ( const
