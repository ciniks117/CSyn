...
#include "nesl_la.h"
#include "cst_robotarm_98bf360f_2.h"
#include "cst_robotarm_98bf360f_2_ds.h"
void cst_robotarm_98bf360f_2_dae ( NeDae * * dae , const NeModelParameters *
...
cst_robotarm_98bf360f_2_dae_ds ( ne_allocator ) , NULL , FALSE , *
