...
#include "nesl_la.h"
#include "cst_robotarm_98bf360f_5.h"
#include "cst_robotarm_98bf360f_5_ds.h"
void cst_robotarm_98bf360f_5_dae ( NeDae * * dae , const NeModelParameters *
...
cst_robotarm_98bf360f_5_dae_ds ( ne_allocator ) , NULL , FALSE , *
