...
#include "nesl_la.h"
#include "cst_robotarm_98bf360f_4.h"
#include "cst_robotarm_98bf360f_4_ds.h"
void cst_robotarm_98bf360f_4_dae ( NeDae * * dae , const NeModelParameters *
...
cst_robotarm_98bf360f_4_dae_ds ( ne_allocator ) , NULL , FALSE , *
