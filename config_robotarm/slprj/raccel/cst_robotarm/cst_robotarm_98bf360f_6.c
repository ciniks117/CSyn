...
cst_robotarm_98bf360f_6_NeDaePrivateData_create ( NeDaePrivateData * smData )
; void cst_robotarm_98bf360f_6_dae ( NeDae * * dae , const NeModelParameters
...
cst_robotarm_98bf360f_6_NeDaePrivateData_create ( smData ) ; * dae =
