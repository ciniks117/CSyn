#include "ne_ds.h"
#include "cst_robotarm_98bf360f_1_ds_zc.h"
#include "cst_robotarm_98bf360f_1_ds_obs_il.h"
#include "cst_robotarm_98bf360f_1_ds_obs_all.h"
#include "cst_robotarm_98bf360f_1_ds_obs_act.h"
#include "cst_robotarm_98bf360f_1_ds_obs_exp.h"
#include "cst_robotarm_98bf360f_1_ds_log.h"
#include "cst_robotarm_98bf360f_1_ds_dxf.h"
#include "cst_robotarm_98bf360f_1_ds_f.h"
#include "cst_robotarm_98bf360f_1_ds.h"
#include "ssc_ml_fun.h"
#include "cst_robotarm_98bf360f_1_ds_external_struct.h"
#include "cst_robotarm_98bf360f_1_ds_sys_struct.h"
#include "cst_robotarm_98bf360f_1_ds_externals.h"
...
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 2U , 0U ,
...
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1.0 , "1" ,
0.0 , TRUE , FALSE , 1U , 1U , NE_INIT_MODE_MANDATORY , "Current" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.v_lag" , 0U
, 0 ,
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
...
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Interface" , 1U , 1U , "rad/s"
...
,
 "cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Interface/Ideal Angular Velocity Source"
...
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Interface/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U , 1U ,
...
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U , 1U , "V"
...
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U , 1U , "A"
...
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U , 1U , "W"
...
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/Electrical Reference2" ,
...
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor" , 1U , 1U , "rad/s" ,
1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Mechanical_Rotational_Reference.W.w"
,
 "cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/Mechanical Rotational Reference"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
,
 "cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/Electrical Reference1"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
...
,
 "cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk/Electrical Reference1"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vbrk.Voltage_Source.i"
,
 "cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
...
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
...
,
 "cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty/Electrical Reference1"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vduty.Voltage_Source.i"
,
 "cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "i" , } , {
...
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Electrical_Reference1.V.v"
,
 "cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev/Electrical Reference1"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.i"
,
 "cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "i" , } , {
...
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.Power_Amplifier.V0.v" ,
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/Power Amplifier" , 1U ,
...
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U , 1U ,
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor" ,
...
"cst_robotarm/6 DOF Robot Arm/DC Motors/Wrist Motor/DC Motor" , 1U , 2U ,
"x6_DOF_Robot_Arm.DC_Motors.Wrist_Motor.DC_Motor" ,
 "/usr/local/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+electromech/+brushed/dc_motor.sscp"
, TRUE ,
...
-> mN ) ; } NeDynamicSystem * cst_robotarm_98bf360f_1_dae_ds ( PmAllocator *
...
cst_robotarm_98bf360f_1_ds_f ; ds -> mMakeOutput [ NE_DS_METHOD_F ] =
...
NE_DS_METHOD_DXF ] = cst_robotarm_98bf360f_1_ds_dxf ; ds -> mMakeOutput [
...
cst_robotarm_98bf360f_1_ds_zc ; ds -> mMakeOutput [ NE_DS_METHOD_ZC ] =
...
NE_DS_METHOD_LOG ] = cst_robotarm_98bf360f_1_ds_log ; ds -> mMakeOutput [
...
cst_robotarm_98bf360f_1_ds_obs_exp ; ds -> mMakeOutput [ NE_DS_METHOD_OBS_EXP
] = ds_output_obs_exp ; ds -> mMethods [ NE_DS_METHOD_OBS_ACT ] =
cst_robotarm_98bf360f_1_ds_obs_act ; ds -> mMakeOutput [ NE_DS_METHOD_OBS_ACT
] = ds_output_obs_act ; ds -> mMethods [ NE_DS_METHOD_OBS_ALL ] =
cst_robotarm_98bf360f_1_ds_obs_all ; ds -> mMakeOutput [ NE_DS_METHOD_OBS_ALL
] = ds_output_obs_all ; ds -> mMethods [ NE_DS_METHOD_OBS_IL ] =
cst_robotarm_98bf360f_1_ds_obs_il ; ds -> mMakeOutput [ NE_DS_METHOD_OBS_IL ]
