...
void cst_robotarm_98bf360f_6_resetSimStateVector ( const void * mech , double
* state ) { double xx [ 1 ] ; ( void ) mech ; xx [ 0 ] = 0.0 ; state [ 0 ] =
xx [ 0 ] ; state [ 1 ] = xx [ 0 ] ; state [ 2 ] = xx [ 0 ] ; state [ 3 ] = xx
[ 0 ] ; state [ 4 ] = xx [ 0 ] ; state [ 5 ] = xx [ 0 ] ; state [ 6 ] = xx [
0 ] ; state [ 7 ] = xx [ 0 ] ; state [ 8 ] = xx [ 0 ] ; state [ 9 ] = xx [ 0
...
void cst_robotarm_98bf360f_6_perturbSimJointPrimitiveState ( const void *
...
} void cst_robotarm_98bf360f_6_constructStateVector ( const void * mech ,
...
[ 27 ] ; } int cst_robotarm_98bf360f_6_isPositionViolation ( const void *
...
[ 3 ] ; double xx [ 53 ] ; ( void ) mech ; ( void ) rtdvd ; ( void ) rtdvi ;
...
return ii [ 1 ] ; } int cst_robotarm_98bf360f_6_isVelocityViolation ( const
...
cst_robotarm_98bf360f_6_projectStateSim ( const void * mech , const
...
, xx + 38 ) ) - state [ 26 ] ) - state [ 28 ] + atan2 (
pm_math_Vector3_dot_ra ( xx + 6 , xx + 23 ) , pm_math_Vector3_dot_ra ( xx + 6
, xx + 34 ) ) ) ; } void cst_robotarm_98bf360f_6_resetModeVector ( const void
* mech , int * modeVector ) { ( void ) mech ; ( void ) modeVector ; }
boolean_T cst_robotarm_98bf360f_6_hasJointDisToNormModeChange ( const void *
mech , const int * prevModeVector , const int * modeVector ) { ( void ) mech
; ( void ) prevModeVector ; ( void ) modeVector ; return 0 ; } PmfMessageId
cst_robotarm_98bf360f_6_performJointDisToNormModeChange ( const void * mech ,
