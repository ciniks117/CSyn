#include "ne_ds.h"
#include "cst_robotarm_breach_98bf360f_4_ds_zc.h"
#include "cst_robotarm_breach_98bf360f_4_ds_obs_il.h"
#include "cst_robotarm_breach_98bf360f_4_ds_obs_all.h"
#include "cst_robotarm_breach_98bf360f_4_ds_obs_act.h"
#include "cst_robotarm_breach_98bf360f_4_ds_obs_exp.h"
#include "cst_robotarm_breach_98bf360f_4_ds_log.h"
#include "cst_robotarm_breach_98bf360f_4_ds_dxf.h"
#include "cst_robotarm_breach_98bf360f_4_ds_f.h"
#include "cst_robotarm_breach_98bf360f_4_ds.h"
...
"cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1/DC Motor" , 2U ,
...
"cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1/DC Motor" , 1.0 ,
...
"cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Gripper Interface" , 1U , 1U ,
...
,
 "cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Gripper Interface/Ideal Angular Velocity Source"
...
"x6_DOF_Robot_Arm.DC_Motors.Gripper_Interface.Ideal_Torque_Sensor.C.w" ,
 "cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Gripper Interface/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
"cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1/DC Motor" , 1U ,
...
, { "x6_DOF_Robot_Arm.DC_Motors.Hand_Motor1.Electrical_Reference2.V.v" ,
 "cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1/Electrical Reference2"
...
"cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1" , 1U , 1U ,
"rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{
"x6_DOF_Robot_Arm.DC_Motors.Hand_Motor1.Mechanical_Rotational_Reference.W.w"
,
 "cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1/Mechanical Rotational Reference"
, 1U , 1U , "rad/s" , 1.0e-6 , "1/s" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
...
,
 "cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1/Power Amplifier/Electrical Reference1"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
...
,
 "cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1/Power Amplifier/SL2Vbrk/Electrical Reference1"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Hand_Motor1.Power_Amplifier.SL2Vbrk.Voltage_Source.i"
,
 "cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
...
"x6_DOF_Robot_Arm.DC_Motors.Hand_Motor1.Power_Amplifier.SL2Vbrk.Volts.v" ,
 "cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1/Power Amplifier/SL2Vbrk"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
...
,
 "cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1/Power Amplifier/SL2Vduty/Electrical Reference1"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Hand_Motor1.Power_Amplifier.SL2Vduty.Voltage_Source.i"
,
 "cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "i" , } , {
...
"x6_DOF_Robot_Arm.DC_Motors.Hand_Motor1.Power_Amplifier.SL2Vduty.Volts.v" ,
 "cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1/Power Amplifier/SL2Vduty"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Hand_Motor1.Power_Amplifier.SL2Vrev.Electrical_Reference1.V.v"
,
 "cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1/Power Amplifier/SL2Vrev/Electrical Reference1"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "x6_DOF_Robot_Arm.DC_Motors.Hand_Motor1.Power_Amplifier.SL2Vrev.Voltage_Source.i"
,
 "cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "A" , 1.0e-6 , "A" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "i" , } , {
...
"x6_DOF_Robot_Arm.DC_Motors.Hand_Motor1.Power_Amplifier.SL2Vrev.Volts.v" ,
 "cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1/Power Amplifier/SL2Vrev"
, 1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"x6_DOF_Robot_Arm.DC_Motors.Hand_Motor1.Power_Amplifier.V0.v" ,
"cst_robotarm_breach/6 DOF Robot Arm/DC Motors/Hand Motor1/Power Amplifier" ,
1U , 1U , "V" , 1.0e-6 , "V" , NE_NOMINAL_SOURCE_NONE , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
...
-> mN ) ; } NeDynamicSystem * cst_robotarm_breach_98bf360f_4_dae_ds (
...
cst_robotarm_breach_98bf360f_4_ds_f ; ds -> mMakeOutput [ NE_DS_METHOD_F ] =
...
NE_DS_METHOD_DXF ] = cst_robotarm_breach_98bf360f_4_ds_dxf ; ds ->
...
cst_robotarm_breach_98bf360f_4_ds_zc ; ds -> mMakeOutput [ NE_DS_METHOD_ZC ]
...
NE_DS_METHOD_LOG ] = cst_robotarm_breach_98bf360f_4_ds_log ; ds ->
...
cst_robotarm_breach_98bf360f_4_ds_obs_exp ; ds -> mMakeOutput [
NE_DS_METHOD_OBS_EXP ] = ds_output_obs_exp ; ds -> mMethods [
NE_DS_METHOD_OBS_ACT ] = cst_robotarm_breach_98bf360f_4_ds_obs_act ; ds ->
mMakeOutput [ NE_DS_METHOD_OBS_ACT ] = ds_output_obs_act ; ds -> mMethods [
NE_DS_METHOD_OBS_ALL ] = cst_robotarm_breach_98bf360f_4_ds_obs_all ; ds ->
mMakeOutput [ NE_DS_METHOD_OBS_ALL ] = ds_output_obs_all ; ds -> mMethods [
NE_DS_METHOD_OBS_IL ] = cst_robotarm_breach_98bf360f_4_ds_obs_il ; ds ->
