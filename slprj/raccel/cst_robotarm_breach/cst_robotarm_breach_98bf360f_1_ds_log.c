...
int32_T cst_robotarm_breach_98bf360f_1_ds_log ( const NeDynamicSystem * sys ,
const NeDynamicSystemInput * t3 , NeDsMethodOutput * t4 ) { PmRealVector out
; real_T x6_DOF_Robot_Arm_DC_Motors_Wrist_Interface_Ideal_Angular_Veloc1 ;
real_T x6_DOF_Robot_Arm_DC_Motors_Wrist_Motor_DC_Motor_i ; real_T t1 ; real_T
