...
#endif
#include "nesl_rtw.h"
#include "cst_robotarm_breach_98bf360f_6.h"
#include "cst_robotarm_breach_98bf360f_6_gateway.h"
void cst_robotarm_breach_98bf360f_6_gateway ( void ) { NeModelParameters
modelparams = { ( NeSolverType ) 0 , 0.001 , 1 , 0 , 0.001 , 0 , 0 , 0 , 0 ,
( SscLoggingSetting ) 0 , 523563476 , } ; NeSolverParameters solverparams = {
...
sizeof ( outputparameters_init [ 0 ] ) ; } cst_robotarm_breach_98bf360f_6_dae
